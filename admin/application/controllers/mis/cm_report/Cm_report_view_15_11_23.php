...
class Cm_report_view extends NIC_Controller {
  ...
  public function District_Wise_Download_Excel($from_date, $to_date)
  {
    ...
    $sheet->setCellValue('C2', 'Prevented');
    $sheet->setCellValue('D2', 'Not Prevented');

    $sheet->setCellValue('E1', 'During');
    $sheet->setCellValue('E2', 'Prevented');
    $sheet->setCellValue('F2', 'Not Prevented');

    $sheet->setCellValue('G1', 'After');
    $sheet->setCellValue('G2', 'Prevented');
    $sheet->setCellValue('H2', 'Not Prevented');

    $sheet->setCellValue('I1', 'Totals');   
    $sheet->setCellValue('I2', 'Prevented');
    $sheet->setCellValue('J2', 'Not Prevented');
    ...
    if($total_row!='')
    {
      ...
      // $sheet->setCellValue("A4:B4",'total');
    }
