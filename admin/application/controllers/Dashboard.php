...
class Dashboard extends NIC_Controller 
{
	...
	public function Generate_legacy_scheduler(){
		$stake_details = $this->session->userdata('stake_details');
		
		if($stake_details=='CMPO'){
			$data['cp_sceduler_count'] = $this->Dashboard_model->cp_previous_scheduler_count();
		}
	}
}
?>