...
class Home_visits_list extends NIC_Controller {
  ...
  public function get_homevist_dtls()
  {
   ...
   if(isset($data['homwvisit_dtls']['disability']))
   {
    ...
    $data['homwvisit_dtls']['type_of_disability_array'] = 'NA';

    $data['homwvisit_dtls']['type_of_disability_values'] = []; // Initialize an array to store values
    $data['homwvisit_dtls']['type_of_disability_values_final'] = '';
    ...
    if(isset($data['homwvisit_dtls']['disability']))
    {
      if($data['homwvisit_dtls']['disability'] == 1)
      {
        if (isset($data['homwvisit_dtls']['type_of_disability'])) 
        {
          $data['homwvisit_dtls']['type_of_disability_array'] = explode(',', $data['homwvisit_dtls']['type_of_disability']);
        }
        else
        {
          $data['homwvisit_dtls']['type_of_disability_array'] = null;
        }
      }
    }
    ...
    // echo "<pre>"; print_r($data['homwvisit_dtls']);die;
    $data['homwvisit_dtls']['type_of_disability_values_final'] = '';
    if(!empty($data['homwvisit_dtls']['type_of_disability_array']) && is_array($data['homwvisit_dtls']['type_of_disability_array']))
    {
    ...
    // (isset($data['homwvisit_dtls']['type_of_disability']))?($data['homwvisit_dtls']['type_of_disability_array'] = explode(',', $data['homwvisit_dtls']['type_of_disability'])):'';
     ...
     // Initialize an empty string to concatenate values
