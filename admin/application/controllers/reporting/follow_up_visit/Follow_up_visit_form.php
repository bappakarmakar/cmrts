...
class Follow_up_visit_form extends NIC_Controller {
  ...
  public function index($incident_id, $cp_type, $cp_id, $scheduler_id) 
  {
    ...
    $scheduler_id = base64_decode($scheduler_id); //ADD BY SOUMEN
  ...
  public function create() {
        ...
        if(empty($filtered_data)){
          ...
          $followUpVisitData['scheduler_id_fk'] =  $scheduler_id; // ADD BY SOUMEN
          ...
          if(count($follow_up_visit_check_status)>0){
            ...
            $scheduler_status_insert =  $this->follow_up_visit_form_model->follow_up_visit_update_by_sl_no_scheduler($scheduler_status,$scheduler_id); //ADD BY SOUMEN
            ...
            $scheduler_status_insert =  $this->follow_up_visit_form_model->follow_up_visit_status_insert_scheduler($scheduler_status,$scheduler_id); //ADD BY SOUMEN
