...
class Follow_up_visit_form extends NIC_Controller {
  ...
  public function create() {
        ...
        if($paid_work==1){
          $this->form_validation->set_rules('paid_work_frequency', '<b>Kishori Group Frequency</b>', 'trim|required|numeric|max_length[2]');
          $this->form_validation_draft->set_rules('paid_work_frequency', '<b>Kishori Group Frequency</b>', 'trim|numeric|max_length[2]');
        }
        ...
        $this->form_validation->set_rules('remarks', '<b>Remarks</b>', 'trim|max_length[100]');
        $this->form_validation_draft->set_rules('remarks', '<b>Remarks</b>', 'trim|max_length[100]');
        ...
        if(empty($filtered_data)){
          ...
          $followup_date =  isset($_POST['followup_date']) ? $this->us_date_format($_POST['followup_date']) : NULL; 
