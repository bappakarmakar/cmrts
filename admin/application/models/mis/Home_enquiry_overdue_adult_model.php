...
class Home_enquiry_overdue_adult_model extends CI_Model
{
    ...
    public function get_home_enquiry_adult_overdue_details($data = array())
    {
        ...
        $this->db->where("cp.cp_dob <= cmir.incident_date - INTERVAL '18 years'"); // Filter only adult cp's
    ...
    public function get_home_enquiry_adult_overdue_report_countwise_details($data = array())
    {
