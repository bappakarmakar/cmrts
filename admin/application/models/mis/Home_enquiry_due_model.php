...
class Home_enquiry_due_model extends CI_Model
{
    ...
    public function get_home_enquiry_due_dtls($data=array())
    {
        ...
        // echo $data['to_date']; echo "<br>";
        // $data['to_date'] = (new DateTime($data['to_date']))->modify('+1 day')->format('Y-m-d');
        // echo $data['to_date']; echo "<br>";die;
        ...
        //$this->db->join('cm_incident_report_contracting_parties AS cp','cmir.incident_id_pk = cp.incident_id_fk and cmir.cp_two_is_available = 1','left');
