         ...
         if ($this->form_validation->run() == TRUE)
         {
            ...
            if($check_result)
            {
               if($check_result[0]['mobile_no'])
               {
                  ...
                  $this->session->set_userdata('stake_holder_login_id_pk', $check_result[0]['stake_holder_login_id_pk']);
         ...
         if($this->form_validation->run() == TRUE)
         {
            ...
            if($request_otp == $this->session->userdata('secretotp')) 
            {
               ...
               else
               {
                  ...
                  redirect('admin/forgot_password/check_otp/'.base64_encode($this->session->userdata('stake_holder_login_id_pk')));
               }
            }
