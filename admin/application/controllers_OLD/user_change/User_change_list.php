...
class User_change_list extends NIC_Controller {
  ...
  public function index() 
  {
    ...
    if($stake_id_fk == 2)
    {
      ...
      $where['stake_id_fk_in'] = array('4');
      $where['requested_subdiv_null'] = 1;
    ...
    {
      $where['stake_id_fk_in'] = array('2','5','6');
    ...
    {
      $where['stake_id_fk_group']['stake_id_fk_in'] = array('3');
      $where['stake_id_fk_group']['or_group']['stake_id_fk_in'] = array('5');
      $where['stake_id_fk_group']['or_group']['requested_district_null'] = 1;
    ...
    $data['requested_data'] = $this->user_change_model->get_request_list($where);
...
// echo json_encode(['status' => 'success', 'message' => 'Request rejected successfully']);
  ...
  public function user_change_list_self() 
  {
    ...
    $where['active_status'] = 1;
    $where['stake_id_fk_in'] = array($stake_id_fk);
    $data['requested_data'] = $this->user_change_model->get_request_list($where);
