...
class Unpublished_home_enquiry_report extends NIC_Controller {
  ...
  public function __construct(){ 
    ...
    $this->load->model('mis/Unpublished_home_enquiry_report_model','unpubEnqModel');
  ...
  public function index()
  {
    ...
    $data['report_result'] = $this->unpubEnqModel->get_home_enquiry_dtls($data);
    // echo "<pre>";print_r($data);
    //  echo "</pre>";
    // DIE;

    $this->load->view($this->config->item('theme').'mis/unpublished_home_enquiry_report/Unpublished_home_enquiry_report_view', $data);
  }
  ...
  public function download_excel()
  {
    ...
    $list_for_name = null;
      ...
      if($data['segregate'] == 'district')
      {
        ...
        $data['group_by'] = $this->district_wise['group_by'];
        $data['order_by'] = $this->district_wise['order_by'];
        $title = "Unpublished_Home_Enquiry_Districtwise";
        //title name 
      ...
      elseif ($data['segregate'] == 'block') 
      {
        ...
        $title = "Unpublished_Home_Enquiry_Blockwise";
      }
      elseif ($data['segregate'] == 'ward_gp') 
      {
        ...
        $title = "Unpublished_Home_Enquiry_WardGP_wise";
        $Identity_Ward_Gp_Block = $this->Master_model->get_ward_gp_block($data['unique_id']);
      ...
      $report_result = $data['report_result'] = $this->unpubEnqModel->get_home_enquiry_dtls($data);
    ...
    $sheet->setCellValue('F3', 'BDO level ');
