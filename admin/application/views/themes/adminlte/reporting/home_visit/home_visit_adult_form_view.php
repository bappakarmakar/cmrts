...
<?php echo form_open('admin/reporting/incident/incident_list/home_visit_adult_form/'.$record_num_1.'/'.$record_num_2.'/'.$record_num_3.'/'.$record_num_4, array('class' => 'home_visit_adult_form', 'name' => 'home_visit_adult_form', 'id' => 'home_visit_adult_form'))?>
