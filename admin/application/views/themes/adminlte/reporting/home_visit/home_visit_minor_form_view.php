...
<?php 
   ...
   $record_num_4 = $this->uri->segment(8); // ADD BY SOUMEN
...
?>
<?php echo form_open('admin/reporting/incident/incident_list/home_visit_minor_form/'.$record_num_1.'/'.$record_num_2.'/'.$record_num_3.'/'.$record_num_4, array('class' => 'home_visit_minor_form', 'name' => 'home_visit_minor_form', 'id' => 'home_visit_minor_form'))?> 
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <div class="box bottom-box" style="margin-top: 75px">
         ...
         <input type="hidden" name="incidentDetailsId" value="<?=$record_num_1.'/'.$record_num_2.'/'.$record_num_3.'/'.$record_num_4 ?>">
         <div class="row">
            <div class="col-md-12">
                  ...
                  <div class="card-body p-0">
                              ...
                              <div class="form-group">
                                 <div class="box-body">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-2">
                                          <input type="radio" name="family_income" id="family_income_1" value="1">
                                       </div>
                                       <div class="col-sm-2">
                                          <input type="radio" name="family_income" id="family_income_2" value="2">
                                       </div>
                                       <div class="col-sm-2">
                                          <input type="radio" name="family_income" id="family_income_3" value="3">
                                       </div>
                              ...
                              <div class="form-group">
                                 <div class="box-body">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-2">
                                          <input type="radio" name="emergencies"  value="1">
                                       </div>
                                       <div class="col-sm-2">
                                          <input type="radio" name="emergencies"  value="2">
                                       </div>
                                       <div class="col-sm-2">
                                          <input type="radio" name="emergencies" value="3">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="card-body">
                                 <div class="form-group row">
                                   ...
                                   <div class="col-sm-7" >
                                       <div class="des-loc">
                                          <div class="inp-radio">
                                             <label class="radio-inline"><input name="disability" type="radio" value="1" class="disability">&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                             <label class="radio-inline"><input name="disability" type="radio" value="2" class="disability">&nbsp;No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                          </div>
                                       </div>
                                   </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                    <div class="des-loc">
                                       ...
                                       ?>
                                          <div class="inp-radio">
                                          <input name="type_of_disability[]" type="checkbox" value="<?php echo $value['sl_no'] ?>">&nbsp;&nbsp;<?php echo $value['description'] ?>
                                          </div>
                                          <?php  } ?>
                                    </div>
                                   </div>
                                          ...
                                          <div class="des-loc">
                                             <div class="inp-radio">
                                                <label class="radio-inline">
                                                   <input name="disability_certificate" class="disability_certificate" type="radio" value="1" class="disability_certificate">&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                                                <label class="radio-inline">
                                                   <input name="disability_certificate" class="disability_certificate" type="radio" value="2" class="disability_certificate">&nbsp;No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                                             </div>
                                          </div>
                                      </div>
                                 ...
                                 <div class="card-body disability_certificate_percent_div" id="if_dis">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <div class="des-loc">
                                             <div class="inp-radio">
                                                <input name="disability_percent" class="form-control" type="text" placeholder="% of disability" value="" maxlength="2"  onkeyup="validateInput(this)">
                                             </div>
                                          </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <table class="table table-bordered">
                                             ...
                                             <tr>
                                                <?php foreach($estimated_severity_details as $value){?> 
                                                <td><input name="estimated_severity" type="radio" value="<?php echo $value['sl_no']?>"></td>
                                                <?php } ?>
                                             </tr>
                                          </table>
                                      </div>
                     ...
                     <div id="tab2" class="tab-pane fade">
                                 ...
                                 <div class="box-body">
                                    <div class="row">
                                       <div class="col-sm-6">
                                          <table class="table table-bordered">
                                             <tr style="background-color: #508de2; color: #FFFFFF;">
                                                <th colspan="2" style="text-align: end;padding-right:38px;">Yes</th>
                                             ...
                                             <tr>
                                                ...
                                                <td><input type="radio" name="kishori_group" class="kishori_group" value="1"></td>
                                                <td><input type="radio" name="kishori_group" class="kishori_group" value="2"></td>
                                             </tr>
                                             <tr>
                                       ...
                                       <div class="col-sm-6">
                                          ...
                                          <table class="table table-bordered" id="documents_collected_table_field">
                                             ...
                                             <tr class="education_data">
                                                ...
                                                <td id="education_frequency"><input type="radio" name="education_frequency" id="education_frequency_1" class="education_frequency"value="1"></td>

                                                <td><input type="radio" name="education_frequency" id="education_frequency_2" class="education_frequency" value="2"></td>

                                                <td><input type="radio" name="education_frequency" id="education_frequency_3" class="education_frequency" value="3"></td>
                                             </tr>
                                             ...
                                             <tr class="kishori_group_data">
                                                ...
                                                <td id="kishori_group_frequency"><input type="radio" name="kishori_group_frequency" id="kishori_group_frequency" class="kishori_group_frequency" value="1"></td>

                                                <td><input type="radio" name="kishori_group_frequency" id="kishori_group_frequency" class="kishori_group_frequency"value="2"></td>

                                                <td><input type="radio" name="kishori_group_frequency" id="kishori_group_frequency" class="kishori_group_frequency"value="3"></td>
                                             </tr>
                                             <tr class="paid_work_data">
                                                
                                                <td id="paid_work_frequency"><input type="radio" name="paid_work_frequency" id="paid_work_frequency" class="paid_work_frequency"value="1"></td>

                                                <td><input type="radio" name="paid_work_frequency" id="paid_work_frequency" class="paid_work_frequency" value="2"></td>

                                                <td><input type="radio" name="paid_work_frequency" id="paid_work_frequency" class="paid_work_frequency" value="3"></td>
                                             </tr>
                                          </table>
                                       </div>
                                    </div>
                              ...
                              <div style="border: 1px solid gray;"></div>
                                 <div class="form-group row" style="padding:10px 0">
                                    ...
                                    <div class="col-sm-2">
                                       ...
                                       ?>
                                       <option <?=($cp_district_id==$value['district_id_pk'])?'selected':''?>  <?php echo set_select('cp_school_district', $value['district_id_pk'], FALSE) ?>  value="<?php echo $value['district_id_pk']; ?>"><?php echo $value['district_name']; ?></option>
                                    <?php } ?>
                                    </select>
                                       ...
                                       <label for="State" class="col-sm-1 col-form-label">Block <span style="color: red;">*</span></label>
                                          <div class="col-sm-2">
                                             <select name="cp_school_block" id="cp_school_block" class="form-control" autocomplete="off">
                                                ...
                                                <option <?=($cp_block_id==$value['block_id_pk'])?'selected':''?> value="<?=$value['block_id_pk']?>"><?=$value['block_name']?></option>
                                             <?php } ?>
                                       ...
                                       <label for="State" class="col-sm-1 col-form-label">School <span style="color: red;">*</span></label>
                                          <div class="col-sm-3">
                                             ...
                                             <select name="bs_school_id" id="bs_school_id" class="form-control" autocomplete="off">
                                                ...
                                                <option value="<?=$value['schcd']?>"><?=$value['school_name']?></option>
                                             <?php } ?>
                                             </select>
                                 ...
                                 <div class="row" style="padding-top:10px;padding-bottom: 10px;">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" name="school_name" class="form-control school_name" id="school_name" placeholder="Please Enter School Name" value="">
                              ...
                              <div class="kp_availed_div">
                                 <div class="form-group row kanyashree_id_val" style="padding:15px 0" id="kp_availed">
                                   <label class="col-sm-3 col-form-label">Has the minor availed of Kanyashree (Y/N)?</label>
                                   <div class="inp-radio col-sm-4">
                                       <label class="radio-inline"><input name="kp_availed" type="radio" value="1" class="kp_availed">&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                       <label class="radio-inline"><input name="kp_availed" type="radio" value="2" class="kp_availed">&nbsp;No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    </div>
                                 </div>
                              </div>
                                 <div class="form-group row kanyashree_id_val kanyashree_id_div" style="padding:15px 0">
                                   <label class="col-sm-2 col-form-label">Kanyashree ID, if any</label>
                                   <div class="col-sm-4">
                                    
                                    
                                     <input name="kanyashree_id" id="kanyashree_id" type="text" class="form-control" placeholder="Kanyashree ID, if any" oncut="return false" oncopy="return false" onpaste="return false" value="" onkeypress="return onlyNumbers(event, this);">
                                       ...
                                       <div class="col-sm-12">
                                          <table class="table table-bordered">
                                             ...
                                             <tr>
                                                ...
                                                <td><input type="radio" name="parents_supported" value="1" ></td>
                                                <td><input type="radio" name="parents_supported" value="2" ></td>
                                                <td><input type="radio" name="parents_supported" value="3" ></td>
                                             </tr>
                                             <tr>
                                                ...
                                                <td><input type="radio" name="family_elders_supported" value="1"></td>
                                                <td><input type="radio" name="family_elders_supported" value="2"></td>
                                                <td><input type="radio" name="family_elders_supported" value="3"></td>
                                             </tr>
                                             <tr>
                                                ...
                                                <td><input type="radio" name="peers_supported" value="1"></td>
                                                <td><input type="radio" name="peers_supported" value="2"></td>
                                                <td><input type="radio" name="peers_supported" value="3"></td>
                                             </tr>
                                             <tr>
                                                ...
                                                <td><input type="radio" name="neighbours_supported" value="1"></td>
                                                <td><input type="radio" name="neighbours_supported" value="2"></td>
                                                <td><input type="radio" name="neighbours_supported" value="3"></td>
                                             </tr>
                                             <tr>
                                                ...
                                                <td><input type="radio" name="others_supported" value="1"></td>
                                                <td><input type="radio" name="others_supported" value="2" ></td>
                                                <td><input type="radio" name="others_supported" value="3"></td>
                                             </tr>
                                          </table>
                                       </div>
                                    </div>
                                 ...
                                 <div class="form-group">
                                    <div class="row">
                                       <div class="col-sm-6">
                                          ...
                                          <label class="radio-inline"><input name="minor_pregnant" class="minor_pregnant" type="radio" value="1">&nbsp;Yes&nbsp;&nbsp;</label>

                                          <label class="radio-inline"><input name="minor_pregnant" class="minor_pregnant" type="radio" value="2">&nbsp;No&nbsp;&nbsp;</label>
                                       ...
                                       <div class="col-sm-6 stage_of_pregnancy">
                                          ...
                                          <label class="radio-inline"><input name="stage_of_pregnancy" class="stage_of_pregnancy_cls" type="radio" value="<?php echo $value['sl_no']?>" >&nbsp;<?php echo $value['description']?>&nbsp;&nbsp;</label>
                                          <?php } ?>
                                 ...
                                 <div class="form-group">
                                    <div class="row">
                                       <div class="col-sm-12">
                                          ...
                                          ?> 
                                          <textarea rows="3" class="form-control" maxlength="100" placeholder="Write Remarks " name="remarks"><?php echo $remarks_val; ?></textarea>
...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $(document).off('submit', '#home_visit_minor_form').on('submit', '#home_visit_minor_form', function (event) {
         event.preventDefault();
         var csrf_token_value = $('input[name=csrf_cmrts]').val();
         var formName = 'home_visit_minor_form';
         var formData = new FormData($('form[name="' + formName + '"]')[0]);
         formData.append("csrf_cmrts", csrf_token_value);
         formData.append("action", "submit");
         $.ajax({
            type: 'POST',
             url: '<?php echo base_url()?>admin/reporting/home_visit/Home_visit_minor_form/create/',
             data: formData,
             processData: false,
             cache: false,
             contentType: false,
