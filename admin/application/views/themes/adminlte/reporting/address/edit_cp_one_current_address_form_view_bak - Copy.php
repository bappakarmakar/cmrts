                        ...
                        <div class="card-body">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-9">
                                 ...
                                 ?>
                                 <label class="radio-inline"><input type="radio" class="cwc_minor_sent_div" name="minor_sent" id="minor_sent" value="<?php echo $value['sl_no']?>" <?php echo set_radio('minor_sent', $value['sl_no']); ?><?php echo ($edit_cp_one_address->minor_sent == $value['sl_no']) ?  "checked" : "" ;  ?>><?php echo $value['description']?></label>&nbsp;&nbsp;
                                 <?php } }else{ ?>
                                 <label class="radio-inline"><input type="radio" class="cwc_minor_sent_div" name="minor_sent" id="minor_sent" value="<?php echo $value['sl_no']?>" <?php echo set_radio('minor_sent', $value['sl_no']); ?><?php echo ($edit_cp_one_address->minor_sent == $value['sl_no']) ?  "checked" : "" ;  ?>> <?php echo $value['description']?></label>&nbsp;&nbsp;
                                 <?php } } ?>
                     ...
                     <div class="box-body CWC_First_Row">
                        <div class="card-body">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <input type="text" placeholder="Case No" class="form-control" id="case_no" autocomplete="off" name="case_no" value="<?php if(set_value('case_no') != ''){?><?php echo set_value('case_no'); ?><?php }else{?><?php echo $edit_cp_one_address->case_no?><?php } ?>">
                           ...
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <select class="form-control district" name="district" id="district">
                                    ...
                                    <option value="<?php echo $district['district_id_pk'];?>" <?php echo set_select('district', $district['district_id_pk'], False); ?><?php if($edit_cp_one_address->district == $district['district_id_pk']){ echo "selected"; }?>><?php echo $district['district_name'];?></option>
                                    <?php } ?>                     
                                 </select>
                           ...
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <select class="form-control" name="block" id="block">
                                    ...
                                    <option value="<?php echo $value['block_id_pk'];?>" <?php echo set_select('block', $value['block_id_pk']); ?> <?php if($value['block_id_pk'] == $edit_cp_one_address->block){ echo "selected"; }?>><?php echo $value['block_name'];?></option>
                                    <?php } ?>
                                 </select>
                     ...
                     <div class="box-body CWC_Third_Row">
                           ...
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <select class="form-control" name="cci_details" id="cci_details">
                                    ...
                                    <?php foreach($CP_One_CWC_CCI as $value){ ?>
                                    <option value="<?php echo $value['sl_no'];?>" <?php echo set_select('cci_details', $value['sl_no']); ?> <?php if($value['sl_no'] == $edit_cp_one_address->cci_details){ echo "selected"; }?>><?php echo $value['cci_name'];?></option>
                                    <?php } ?>
                                 </select>
                        ...
                        <div class="card-body CWC_Address_Div">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <input type="text" class="form-control" id="address" autocomplete="off" name="address" placeholder="Address" value="<?php if(set_value('address') != ''){?><?php echo set_value('address'); ?><?php }else{?><?php echo $edit_cp_one_address->address; ?><?php } ?>">
                        ...
                        <div class="card-body">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <textarea rows="3" name="remarks" class="form-control" placeholder="Remarks"><?php if(set_value('remarks') != ''){?><?php echo set_value('remarks'); ?><?php }else{?><?php echo $edit_cp_one_address->remarks; ?><?php } ?></textarea>
