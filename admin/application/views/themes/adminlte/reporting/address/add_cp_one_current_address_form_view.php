...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <div class="box bottom-box">
         <?php echo form_open('admin/reporting/address/address_list/add_cp_one_current_address/'.$record_num, array('class' => 'AddressChangeForm','name' => 'AddressChangeForm', 'id' => 'AddressChangeForm')) ?>
               ...
               <div class="card card-default">
                  <div class="card-body p-0">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <?php 
                                // if($this->session->userdata('block') == '0' && $this->session->userdata('subdiv') != '')
    ...
    // alert("hello");
      ...
      if(fetch_entered_address != ''){
        if(fetch_entered_address == undefined){
            ...
            $.ajax({
              url:'<?php echo base_url()?>admin/reporting/address/Address_list/Fetch_CP_One_Entered_Address',
              type:'GET',
              ...
              success: function(response)
              {
                ...
                var cp_one_block = response.cp_one_block;
                var cp_one_district = response.cp_one_district;
                var cp_one_age = response.cp_one_age;
                var cp_one_ward_gp = response.cp_one_ward_gp;

                var street_landmark = response.cp_one_street_landmark;
                var cp_one_police_station = response.cp_one_police_station;
                var cp_one_pin_code = response.cp_one_pin_code;
                var cp_one_ward_gp = response.cp_one_ward_gp;
                var cp_one_ward_gp_id = response.cp_one_ward_gp_id;
                var cp_one_ward_gp_name = response.cp_one_ward_gp_name;

                // alert(cp_one_ward_gp);
                 // alert(cp_one_ward_gp_name);
