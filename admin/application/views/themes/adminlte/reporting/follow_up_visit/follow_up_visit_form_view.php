...
<?php 
   ...
   $record_num_4 = $this->uri->segment(8); //BY SOUMEN
...
?>
<?php echo form_open('admin/reporting/incident/incident_list/follow_up_visit_form/'.$record_num_1.'/'.$record_num_2.'/'.$record_num_3.'/'.$record_num_4, array('class' => 'follow_up_visit_form','name' => 'follow_up_visit_form', 'id' => 'follow_up_visit_form'))?>
         ...
         <div class="form-group">
            <div class="box-body">
               <div class="row" style="">
                  <div class="col-md-9">
                     ...
                     <div class="name-add-section" style="width: 60%;padding-top: 40px;">
                        ...
                        <div class="form-group" style="margin-top: 20px;width: 50%;">
                           ...
                           <input type="text" class="form-control homeEnquiryDatepicker" id="followup_date" placeholder="Date of Follow up " readonly autocomplete="off" name="followup_date" value="" style="background-color: white;" tabindex="7">
                        ...
                        <div class="form-group" style="margin-top: 20px;width: 50%;">
                           ...
                           <input type="text" class="form-control " name="age_on_folllowup" id="age_on_folllowup" autocomplete="off" placeholder="Age" value="" maxlength="2" readonly style="cursor: not-allowed;">
                         </div>
                     </div>
                  </div>
                  <div class="col-md-3" style="float: right;padding-top: 40px;">
                  <label style="float: left;margin-right: 34px;">Mode of Enquiry <sup style="color: #FF0000;">*</sup></label><br>
                  <div class=""style="">
                     <div style="width:100%; float:right; " >
                        <table class="table table-bordered" id="mode_of_enquiry">
                           ...
                           <tr style="background-color:#0002">
                              <td>
                                 <span style="margin-left: 0%; background-color: ; "><b><?php echo $value['description']?></b></span><input style="float: right" type="radio" name="mode_of_enquiry"  value="<?php echo $value['sl_no']?>" <?php echo set_radio('mode_of_enquiry', $value['sl_no']); ?>><?php echo form_error('mode_of_enquiry'); ?>
                              </td>
                           </tr>
                           <?php } ?>
                        </table>
                ...
                <div class="row" style="">
                  <label style="float: left;margin-right: 60px;margin-top: 15px;">Gender <sup style="color: #FF0000;">*</sup></label><br>
                  <div class="col-sm-12">
                     <div style="width:100%;  " >
                  ...
                  <div class="col-sm-6">
                     <table class="table table-bordered">
                        ...
                        <tr>
                           ...
                           <td><input type="radio" name="kishori_group" class="kishori_group" value="1" <?php echo set_radio('kishori_group', 1); ?>></td>
                           <td><input type="radio" name="kishori_group" class="kishori_group" value="2" <?php echo set_radio('kishori_group', 2); ?>></td>
                        </tr>
                        <tr>
                  ...
                  <div class="col-sm-6">
                     ...
                     <table class="table table-bordered" id="documents_collected_table_field">
                        ...
                        <tr class="education_data">
                           <td><input type="radio" name="education_frequency" class="education_frequency" value="1" <?php echo set_radio('education_frequency', 1); ?>></td>

                           <td><input type="radio" name="education_frequency" class="education_frequency" value="2" <?php echo set_radio('education_frequency', 2); ?>></td>

                           <td id="education_frequency"><input type="radio" name="education_frequency" class="education_frequency" value="3" <?php echo set_radio('education_frequency', 3); ?>></td>
                        </tr>
                        
                        <tr class="kishori_group_data">
                           <td><input type="radio" name="kishori_group_frequency" class="kishori_group_frequency" value="1" <?php echo set_radio('kishori_group_frequency', 1); ?>></td>

                           <td><input type="radio" name="kishori_group_frequency" class="kishori_group_frequency" value="2" <?php echo set_radio('kishori_group_frequency', 2); ?>></td>

                           <td id="kishori_group_frequency"><input type="radio" name="kishori_group_frequency"  class="kishori_group_frequency" value="3" <?php echo set_radio('kishori_group_frequency', 3); ?>></td>
                        </tr>
                        <tr class="paid_work_data">
                           <td><input type="radio" name="paid_work_frequency" class="paid_work_frequency" value="1" <?php echo set_radio('paid_work_frequency', 1); ?>></td>

                           <td><input type="radio" name="paid_work_frequency" class="paid_work_frequency" value="2" <?php echo set_radio('paid_work_frequency', 2); ?>></td>

                           <td id="paid_work_frequency"><input type="radio" name="paid_work_frequency"  class="paid_work_frequency" value="3" <?php echo set_radio('paid_work_frequency', 3); ?>></td>
                        </tr>
                     </table>
                  </div>
               </div>
                  ...
                  <div class="col-sm-12">
                     <table class="table table-bordered">
                        ...
                        <tr>
                           ...
                           <td><input type="radio" name="parents_supported" value="1" <?php echo set_radio('parents_supported', 1); ?>></td>

                           <td><input type="radio" name="parents_supported" value="2" <?php echo set_radio('parents_supported', 2); ?>></td>

                           <td><input type="radio" name="parents_supported" value="3" <?php echo set_radio('parents_supported', 3); ?>></td>
                        </tr>
                        <tr>
                           <td style="text-align: left; font-weight: bold;">Family elders<samp id="family_elders_supported"></td>
                           <td><input type="radio" name="family_elders_supported" value="1" <?php echo set_radio('family_elders_supported', 1); ?>></td>

                           <td><input type="radio" name="family_elders_supported" value="2" <?php echo set_radio('family_elders_supported', 2); ?>></td>

                           <td><input type="radio" name="family_elders_supported" value="3" <?php echo set_radio('family_elders_supported', 3); ?>></td>
                        </tr>
                        <tr>
                           <td style="text-align: left; font-weight: bold;">Peers<samp id="peers_supported"></td>
                           <td><input type="radio" name="peers_supported" value="1" <?php echo set_radio('peers_supported', 1); ?>></td>

                           <td><input type="radio" name="peers_supported" value="2" <?php echo set_radio('peers_supported', 2); ?>></td>

                           <td><input type="radio" name="peers_supported" value="3" <?php echo set_radio('peers_supported', 3); ?>></td>
                        </tr>
                        <tr>
                           <td style="text-align: left; font-weight: bold;">Neighbours<samp id="neighbours_supported"></td>
                           <td><input type="radio" name="neighbours_supported" value="1" <?php echo set_radio('neighbours_supported', 1); ?>></td>

                           <td><input type="radio" name="neighbours_supported" value="2" <?php echo set_radio('neighbours_supported', 2); ?>></td>

                           <td><input type="radio" name="neighbours_supported" value="3" <?php echo set_radio('neighbours_supported', 3); ?>></td>
                        </tr>
                        <tr>
                           <td style="text-align: left; font-weight: bold;">Others<samp id="others_supported"></td>
                           <td><input type="radio" name="others_supported" value="1" <?php echo set_radio('others_supported', 1); ?>></td>

                           <td><input type="radio" name="others_supported" value="2" <?php echo set_radio('others_supported', 2); ?>></td>

                           <td><input type="radio" name="others_supported" value="3" <?php echo set_radio('others_supported', 3); ?>></td>
                        </tr>
                     </table>
                  </div>
               </div>
            ...
            <div class="form-group">
               <div class="row">
                  <div class="col-sm-6">
                     ...
                     <label class="radio-inline"><input name="minor_pregnant" class="minor_pregnant" type="radio" value="1" <?php echo set_radio('minor_pregnant', 1); ?>>&nbsp;Yes</label>&nbsp;&nbsp;

                     <label class="radio-inline"><input name="minor_pregnant" class="minor_pregnant" type="radio" value="2" <?php echo set_radio('minor_pregnant', 2); ?>>&nbsp;No</label>&nbsp;&nbsp;
                  ...
                  <div class="col-sm-6 stage_of_pregnancy">
                     ...
                     <label class="radio-inline"><input name="stage_of_pregnancy" class="stage_of_pregnancy_cls" type="radio" value="<?php echo $value['sl_no']?>" <?php echo set_radio('stage_of_pregnancy', $value['sl_no']); ?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                     <?php } ?>
            ...
            <div class="form-group">
               <div class="row">
                  <div class="col-sm-12">
                     ...
                     <textarea rows="3" class="form-control" maxlength="100" name="remarks" placeholder="Write remarks"><?php echo set_value('remarks')?></textarea>
...
<script type="text/javascript">
   $(document).ready(function(){
      $(document).off('submit', '#follow_up_visit_form').on('submit', '#follow_up_visit_form',function (event) {
         event.preventDefault();
         var csrf_token_value = $('input[name=csrf_cmrts]').val();
         var formName = 'follow_up_visit_form';
         var formData = new FormData($('form[name="' + formName + '"]')[0]);
         formData.append("csrf_cmrts", csrf_token_value);
         formData.append("action", "submit");
         $.ajax({
            type: 'POST',
             url: '<?php echo base_url()?>admin/reporting/follow_up_visit/follow_up_visit_form/create/',
             data: formData,
             processData: false,
             cache: false,
             contentType: false,
