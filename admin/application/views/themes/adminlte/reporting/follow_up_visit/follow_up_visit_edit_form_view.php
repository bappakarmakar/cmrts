                  ...
                  <div class="col-md-9">
                     ...
                     <div class="name-add-section" style="width: 60%;padding-top: 40px;">
                        ...
                        <div class="form-group" style="margin-top: 20px;width: 50%;">
                           ...
                           <input type="text" class="form-control " name="age_on_folllowup" id="age_on_folllowup" autocomplete="off" placeholder="Age" value="<?php echo $age_on_folllowup; ?>" maxlength="2" readonly style="cursor: not-allowed;">
                         </div>
                     </div>
                  </div>
