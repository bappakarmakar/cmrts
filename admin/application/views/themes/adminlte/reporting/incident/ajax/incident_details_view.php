                           ...
                           <div class="card-body p-0">
                              ...
                              <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="text" class="form-control" value="<?php echo $incident_details->cp_1_age; ?>" disabled> 
                                    </div>
                                 </div>
                                 <div class="form-group row">
                              ...
                              <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Age</label>
                                    <div class="col-sm-6">
                                       <input type="text" class="form-control" value="<?php echo $incident_details->cp_2_age; ?>" disabled>  
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">DOB document available?</label>
