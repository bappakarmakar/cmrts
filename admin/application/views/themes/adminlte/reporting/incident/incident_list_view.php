...
.police_case_save .sweet-alert h2{
  font-size: 13px!important;
}
.police_case_save .sa-button-container{
  display: flex!important;
  justify-content: space-around!important;
}
.police_case_save .sa-button-container button{
            ...
            <table class="table table-bordered table-hover" id="mytable">
               <thead>
                  ...
                  <tr class="custom_table_head">
                     ...
                     <th class="text-center">Police Case</th>
               ...
               <!-- ====== SCHEDULER VIEW FOR 1,2,4,5,6 Code Add by Soument at 22-03-2025 ============= -->                               
                             <!--  <?php if(($this->session->userdata('stake_id_fk') == '6')|| ($this->session->userdata('stake_id_fk') == '1') || ($this->session->userdata('stake_id_fk') == '2') || ($this->session->userdata('stake_id_fk') == '5') || ($this->session->userdata('stake_id_fk') == '3')){
                                    // echo "helooo";
                                    if($value->current_status == 3){
                                    if($this->session->userdata('block') == $value->cp_1_block_id){
                                    if($value->cp_1_type==1){ ?>
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href="<?php echo base_url()?>admin/reporting/incident/incident_list/fusc/<?php echo base64_encode($value->incident_id_pk); ?>/<?php echo base64_encode($value->cp_1_type); ?>/<?php echo base64_encode($value->cp_1_id_pk); ?>"><i class="fa fa-list" aria-hidden="true"></i>CP 1 Home Enquiry & Follow-Up Visit Scheduler</a></li>
                                    
                                    <?php } } 
                                    if($this->session->userdata('block') == $value->cp_2_block_id){
                                    if(!empty($value->cp_2_type) && $value->cp_2_type==2){ ?>
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href="<?php echo base_url()?>admin/reporting/incident/incident_list/fusc/<?php echo base64_encode($value->incident_id_pk); ?>/<?php echo base64_encode($value->cp_2_type); ?>/<?php echo base64_encode($value->cp_2_id_pk); ?>"><i class="fa fa-list" aria-hidden="true"></i>CP 2 Home Enquiry & Follow-Up Visit Scheduler</a></li>  

                              <?php } 
                                 }
                                 if(($this->session->userdata('stake_id_fk') == '6')){ 
                                 if($value->rural_urban == 'U'){
                                 if($this->session->userdata('district') == $value->cp1_dist){ //cp1_dist added in model
                                    
                                    if($value->cp_1_type==1){ ?>
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href="<?php echo base_url()?>admin/reporting/incident/incident_list/fusc/<?php echo base64_encode($value->incident_id_pk); ?>/<?php echo base64_encode($value->cp_1_type); ?>/<?php echo base64_encode($value->cp_1_id_pk); ?>"><i class="fa fa-list" aria-hidden="true"></i>CP 1 Home Enquiry & Follow-Up Visit Scheduler</a></li>
                                    
                                    <?php }  } 
                                    if($this->session->userdata('district') == $value->cp2_dist){ //cp2_dist added in model
                                    if(!empty($value->cp_2_type) && $value->cp_2_type==2){ ?>
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href="<?php echo base_url()?>admin/reporting/incident/incident_list/fusc/<?php echo base64_encode($value->incident_id_pk); ?>/<?php echo base64_encode($value->cp_2_type); ?>/<?php echo base64_encode($value->cp_2_id_pk); ?>"><i class="fa fa-list" aria-hidden="true"></i>CP 2 Home Enquiry & Follow-Up Visit Scheduler</a></li>  
                            ...
                            <!-- SNO Login -->
                              ...
                              <!-- CMPO , MIS Login -->
                              <?php if($this->session->userdata('stake_id_fk') == '3' || ($this->session->userdata('stake_id_fk') == '5')){
                                    if($value->current_status == 3){
                ...
                <!-- === SCHEDULER VIEW FOR 1,2,3,5,6 Code Add by Soumen at 22-03-2025 ======= -->
                              ...
                              <?php if($this->session->userdata('stake_id_fk') == '4'){
                                ...
                                <!-- ========== Scheduler end cp1 & cp2 ==================== -->


                                <!-- ---------- DEO Police Case Button Start --------------- -->
                                <?php 
                                  if($value->current_status == 3){
                                    if($value->cp_1_age < 18 && $value->cp1_police_case==0){
                                      if($this->session->userdata('block') == $value->cp_1_block_id){
                                  ?>
                                    <li role="presentation">
                                      <a role="menuitem" tabindex="-1" onclick="police_case_form(<?php echo $value->incident_id_pk ?>,<?php echo $value->cp_1_id_pk ?>,<?php echo $value->cp_1_type ?>, <?php echo $value->reporting_id ?>, '<?php echo $value->incident_date ?>','<?php echo $value->cp_1_name ?>', '<?php echo $value->cp_1_gender_value ?>')" > <i class="fa fa-address-card" aria-hidden="true"></i>CP1 Police Cases</a>
                                    </li>

                                  <?php } }if($value->cp_2_age < 18 && $value->cp2_police_case==0){
                                  if($this->session->userdata('block') == $value->cp_2_block_id){ ?>

                                    <li role="presentation">
                                      <a role="menuitem" tabindex="-1" onclick="police_case_form(<?php echo $value->incident_id_pk ?>,<?php echo $value->cp_2_id_pk ?>,<?php echo $value->cp_2_type ?>, <?php echo $value->reporting_id ?>, '<?php echo $value->incident_date ?>','<?php echo $value->cp_2_name ?>', '<?php echo $value->cp_1_gender_value ?>')" > <i class="fa fa-address-card" aria-hidden="true"></i>CP2 Police Cases</a>
                                    </li>

                                  <?php } } } ?>
                                  <!-- ----------- DEO Police Case Button End --------------- -->
                              ...
                              <?php } ?>
                                ...
                                <!-- ---------- CMPO Police Case Button Start ----------- -->
                                <?php 
                                // echo "<pre>"; print_r($this->session->userdata());
                                  if($value->current_status == 3){
                                    if($value->cp_1_age < 18 && $value->cp1_police_case==0){
                                      if($this->session->userdata('district') == $value->cp_1_district_id){
                                  ?>
                                    <li role="presentation">
                                      <a role="menuitem" tabindex="-1" onclick="police_case_form(<?php echo $value->incident_id_pk ?>,<?php echo $value->cp_1_id_pk ?>,<?php echo $value->cp_1_type ?>, <?php echo $value->reporting_id ?>, '<?php echo $value->incident_date ?>','<?php echo $value->cp_1_name ?>', '<?php echo $value->cp_1_gender_value ?>')" > <i class="fa fa-address-card" aria-hidden="true"></i>CP1 Police Cases</a>
                                    </li>
                                  ...
                                  <?php } }if($value->cp_2_age < 18 && $value->cp2_police_case==0){
                                  if($this->session->userdata('district') == $value->cp_2_district_id){ ?>
                              ...
                              <!-- <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/download/<?php echo base64_encode($value->reporting_id); ?>" target="_blank"><i class="fa fa-download" aria-hidden="true"></i>Download</a></li> -->
                           </ul>
                        </div>
                     </td>
                  </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding: 15px;padding-top: 10px">
        ...
        <form id="police_case_form_data">
          <div class="custom-box">
                  ...
                  <div class="col-sm-12">
                    ...
                    <select class="form-control" id='police_case_station' name='police_case_station'>
                      ...
                      <?php foreach ($police_station as $value) { ?>
                        <option value="<?php echo $value['police_station_id_pk'] ?>"><?php echo $value['police_station_name'] ?></option>
                      <?php } ?>
                    </select>
              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <textarea class="form-control press_enter" id="filing_complaint" name="filing_complaint" placeholder="Enter complaint (letters, numbers, / - , and spaces allowed)" onkeyup="validateTextField(this); validateInput(3);"></textarea>
                    <div class="char-count">0 / 300</div>
                    <div id="person_error" style="color: red; display: none;">Only letters, numbers, / - , and spaces allowed.</div>
              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <textarea class="form-control press_enter" id="description_complain" name="description_complain" placeholder="Enter Description of complaint Enter complaint (letters, numbers, / - , and spaces allowed)" onkeyup="validateTextField(this)"></textarea>
                    <div class="char-count">0 / 300</div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <input class="form-check-input section-checkbox" type="checkbox" id="section_9" name="pcma_section[]" value="9">
                    <label class="form-check-label" for="section_9">Section 9</label>
                  </div>
                  <div class="col-md-4">
                    <input class="form-check-input section-checkbox" type="checkbox" id="section_10" name="pcma_section[]" value="10">
                    <label class="form-check-label" for="section_10">Section 10</label>
                  </div>
                  <div class="col-md-4">
                    <input class="form-check-input section-checkbox" type="checkbox" id="section_11" name="pcma_section[]" value="11">
          ...
          <input type="hidden" name="validation_error_count" id="validation_error_count">
          ...
          <div class="modal-footer" style="text-align: right;padding: 5px">
            ...
            <button type="button" class="btn btn-primary" id="save_btn" onclick="police_case_draft_save()">Save</button>
...
<script type="text/javascript">
  ...
  function validateInput(flag) {
    ...
    if (flag == 1) {
      ...
      value = $('#filing_complaint').val();
      errorMessage = 'Only letters, numbers, /, -, and spaces are allowed.';
    }

    if (!regex.test(value)) {
      if (flag == 1) {
        $('#gd_error').text(errorMessage).show();
        $('#gd_number').val(value.replace(/[^A-Za-z0-9\s,\/-]/g, ''));
      } else if (flag == 2) {
        $('#fir_error').text(errorMessage).show();
        $('#fir_no').val(value.replace(/[^A-Za-z0-9\s,\/-]/g, ''));
      } else if (flag == 3) {
        $('#person_error').text(errorMessage).show(); // Correct error container
        $('#filing_complaint').val(value.replace(/[^A-Za-z0-9\s,\/-]/g, ''));
      }
    } else {
      if (flag == 1) {
        $('#gd_error').hide();
        ...
        $('#person_error').hide(); // Correct error container
      }
    }
  }
  ...
  function police_case_form(incident_id, cp_id, cp_type, reporting_id, incident_date, cp_name, cp_gender){
  ...
  // Add this before your police case draft save function
  function showError(selector) {
    $(selector).fadeIn(500); // Show only the relevant error
  }

  //  Hide validation Error after put the field value
  function hideError(selector) {
    $(selector).fadeOut(500);
  }

  $('#gd_number').on('keyup blur', function() {
    if ($(this).val().trim() !== '') hideError('#gd_no_error');
  });

  $('#gd_date').on('change', function() {
      if ($(this).val().trim() !== '') hideError('#gd_date_error');
  });

  $('#fir_no').on('keyup blur', function() {
      if ($(this).val().trim() !== '') hideError('#fir_no_error');
  });

  $('#fir_date').on('change', function() {
      if ($(this).val().trim() !== '') hideError('#fir_date_error');
  });

  $('#police_case_station').on('change', function() {
      if ($(this).val() !== '0') hideError('#police_case_station_error');
  });

  $('#filing_complaint').on('keyup blur', function() {
      if ($(this).val().trim() !== '') hideError('#complain_error');
  });

  $('#persons_accused').on('keyup blur', function() {
      if ($(this).val().trim() !== '') hideError('#persons_accused_error');
  });

  $('#description_complain').on('keyup blur', function() {
      if ($(this).val().trim() !== '') hideError('#description_error');
  });

  $('#off_first_name').on('keyup blur', function() {
      if ($(this).val().trim() !== '') hideError('#off_firstname_error');
  });

  $('#off_last_name').on('keyup blur', function() {
      if ($(this).val().trim() !== '') hideError('#off_lastname_error');
  });

  $('#officer_designation').on('change', function() {
      if ($(this).val() !== '0') hideError('#off_designation_error');
  });

  $('.section-checkbox').on('change', function() {
      if ($('.section-checkbox:checked').length > 0) {
          hideError('#pcm_section_error');
      }
  });

  // ------------------------- 24-04-2025 -------------------------

  function police_case_draft_save(){
      ...
      var errorCount = 0; // Counter for validation errors
      ...
      // Validation checks
        ...
        if(errorCount>0){
          ...
          swal({
            ...
            function(isConfirm){
              if(isConfirm){
                swal.close(); // Close only if form is valid
                $('#police_case_modal').find('input,select,textarea,button').prop('disabled',false);
                police_case_save_as_draft(url, formData);
              } else {
                police_case_save(url, formData);
              }
            }
          );

        } else {
            // alert('Else--->>'+errorCount);
            swal({
              title: "Police case saved in the register",
              type: "warning",
              customClass: 'police_case_save',
              confirmButtonClass: "btn-success",
              closeOnConfirm: false,
  ...
  // Police Case save as draft validation Error is 0 
  function police_case_save_as_draft(url, formData){
    $.ajax({
      url: url, 
      method: 'GET',
      data: formData,
  ...
  // Police Case save if any validation error is present or not
  function police_case_save(url, formData){
    $.ajax({
        url: url, 
        method: 'GET',
        data: formData,
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    setTimeout(function(){
                     ...
                     // SMS send function calling after intervention successfull piblished
