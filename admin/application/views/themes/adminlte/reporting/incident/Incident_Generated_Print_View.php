                 ...
                 <div class="card-body p-0">
                                ...
                                <div class="card-body">
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-lg-5 col-md-5 col-xs-5 col-xs-5">
                                         <input type="text" class="form-control date-picker" data-date-end-date="0d" id="incident_date" placeholder="Incident Date" readonly autocomplete="off" name="incident_date" value="<?=($incident_edit_details)?date('d/m/y',strtotime($incident_edit_details['incident_date'])):''; ?>" tabindex="7">
                                      </div>
                                    </div>
                                <div class="card-body">
                                   <div class="form-group row">
                                      ...
                                      <div class="col-lg-5 col-md-5 col-xs-5 ">
                                         <input type="text" class="form-control date-picker" data-date-end-date="0d" id="marriage_date"  readonly autocomplete="off" name="marriage_date" value="<?php echo !empty($incident_edit_details['marriage_date']) ? date('d-m-Y', strtotime($incident_edit_details['marriage_date'])) : ''; ?>" tabindex="7">
                                      </div>
                                      
                                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                       <div class="right_marriage_details">
                                         <?php
                                            $mrg_dtl_val= '';
                                            ...
                                            ?>
                                         <span style="<?php echo $marriage_details_css; ?>"><?php echo $value['description']?></span>
                                         <input type="radio" value="<?php echo $value['cm_marriage_master_id_pk']?>" name="marriage_details" <?=($incident_edit_details)?($incident_edit_details['marriage_details']==$value['cm_marriage_master_id_pk'])?'checked':'':''?> class="mar-det" style="float: right;margin-right: 85px;"><br>
                                         <?php } ?>
                                      </div>
                                   </div>
                                   </div>
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-xs-5 col-xs-5">
                                         <input type="text" placeholder="Street / Landmark" class="form-control" id="street_landmark" autocomplete="off" name="street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['street_landmark']:""; ?>">
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                      <div class="col-xs-3 col-xs-3">
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-xs-5 col-xs-5">
                                         <input type="text" class="form-control" value="<?=($incident_edit_details)?$incident_edit_details['incident_district']:""; ?>">
                                      </div>
                                      <div class="col-xs-1"></div>
                                   </div>
                                   <div class="form-group row">
                                      ...
                                      <div class="col-xs-5 col-xs-5">
                                         <input type="text" class="form-control" value="<?=($incident_edit_details)?$incident_edit_details['incident_block']:""; ?>">
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-xs-5 col-xs-5">
                                         <input type="text" class="form-control" placeholder="Police Station" name="police_station" id="police_station" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['police_station']:""; ?>">
                                      </div>
                                   </div>
                                  <div class="form-group row">
                                ...
                                <div class="card-body" id="Anonymous_1">
                                   <div class="form-group row">
                                      ...
                                      <div class="col-sm-9  col-xs-9">
                                         <input type="text" class="form-control" placeholder="If identity known Name" name="identity_known_name" id="identity_known_name" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['identity_known_name']:""; ?>">
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                      <label class="col-xs-3 col-form-label">Street / Landmark</label>
                                      <div class="col-sm-9  col-xs-9">
                                         <input type="text" placeholder="Street / Landmark" class="form-control" id="identity_street_landmark" autocomplete="off" name="identity_street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['identity_street_landmark']:""; ?>">
                                      </div>
                                   </div>
                                </div>
                                <div class="card-body" id="Anonymous_2">
                                   <div class="left-form">
                                      ...
                                      <div class="form-group row">
                                         ...
                                         <div class="col-xs-5">
                                            <input type="text" class="form-control js-input-mobile" placeholder="Pin Code" name="identity_pin_code" id="identity_pin_code" autocomplete="off" maxlength="6" value="<?=($incident_edit_details)?$incident_edit_details['identity_pin_code']:""; ?>">
                                         </div>
                                      </div>
                                      <div class="form-group row">
                                         <label class="col-xs-3 col-form-label">Police Station</label>
                                         <div class="col-xs-5">
                                            <input type="text" class="form-control" placeholder="Police Station" name="identity_police_station" id="identity_police_station" autocomplete="off"  value="<?=($incident_edit_details)?$incident_edit_details['identity_police_station']:""; ?>">
                                         </div>
                                      </div>
                                      <div class="form-group row">
                                         <label class="col-xs-3 col-form-label">Phone No</label>
                                         <div class="col-xs-5">
                                            <input type="text" class="form-control js-input-mobile" placeholder="Phone No" name="identity_phone_no" id="identity_phone_no" autocomplete="off" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['identity_phone_no']:""; ?>">
                                         </div>
                                      </div>
                             ...
                             <div id="step-two" class="content" role="tabpanel" aria-labelledby="step-two-trigger">
                                ...
                                <div class="card-body">
                                   <div class="form-group row">
                                      ...
                                      <div class="  col-xs-9">
                                         <input type="text" class="form-control" placeholder="Name" name="cp_one_name" id="cp_one_name" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_name']:''?>">
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                      <label class="col-xs-3 col-form-label">Street / Landmark</label>
                                      <div class="col-sm-9  col-xs-9">
                                         <input type="text" placeholder="Street / Landmark" class="form-control" id="cp_one_street_landmark" autocomplete="off" name="cp_one_street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_street_landmark']:""; ?>">  
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                    ...
                                    <?php if($incident_edit_details['cp_1_state'] !=1){ ?> 
                                     <div id="cp_1_address_div_two">
                                       <div class="form-group row">
                                         ...
                                         <div class="col-sm-6">
                                           <textarea class="form-control" name="cp_1_address" id="cp_1_address" rows="3" placeholder="Address"><?=($incident_edit_details)?$incident_edit_details['cp_1_address']:set_value('cp_1_address'); ?></textarea>
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-sm-6 col-xs-6">
                                         <input type="text" class="form-control js-input-mobile" placeholder="Pin Code" name="cp_one_pin_code" id="cp_one_pin_code" autocomplete="off" maxlength="6" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_pin_code']:""; ?>">  
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                      <label class="col-xs-3 col-form-label">Police Station</label>
                                      <div class="col-sm-6 col-xs-6">
                                         <input type="text" class="form-control" placeholder="Police Station" name="cp_one_police_station" id="cp_one_police_station" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_police_station']:""; ?>">  
                                      </div>
                                   </div>
                                   <div class="form-group row">
                                      <label class="col-xs-3 col-form-label">Phone No</label>
                                      <div class="col-sm-6 col-xs-6">
                                         <input type="text" class="form-control js-input-mobile" placeholder="Phone No" name="cp_one_phone_no" id="cp_one_phone_no" autocomplete="off" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_phone_no']:""; ?>"> 
                                      </div>
                                   </div>
                                </div>
                                <hr style="border: 1px solid gray;">
                                ...
                                <div class="card-body">
                                   <div class="form-group row">
                                      ...
                                      <div class="col-sm-6">
                                        <input type="text" class="form-control datepicker" data-date-end-date="0d" id="cp_one_dob" placeholder="Date of Birth" autocomplete="off" name="cp_one_dob" value="<?php echo !empty($incident_edit_details['cp_1_dob']) ? date('d-m-Y', strtotime($incident_edit_details['cp_1_dob'])) : ''; ?>" style="background-color: white;" readonly tabindex="7">
                                ...
                                <div class="card-body" id="dob_document_available_cp_one" <?php if($incident_edit_details['cp_1_dob_document_available'] == 1){?>style="display: block;"<?php }else{ ?>style="display: none;"<?php } ?>>
                                   <div class="form-group row">
                                      <label class="col-xs-3 col-form-label">Document ID</label>
                                      <div class="col-sm-6 col-xs-6">
                                         <input type="text" class="form-control" placeholder="Document ID" name="cp_one_dob_document_id" id="cp_one_dob_document_id" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_dob_document_id']:""; ?>">
                                ...
                                <div class="card-body" id="identity_document_available_cp_one" <?php if($incident_edit_details['cp_1_identity_document_available'] == 1){?>style="display: block;"<?php }else{ ?>style="display: none;"<?php } ?>>
                                   <div class="form-group row">
                                      ...
                                      <div class="col-sm-12">
                                         <table class="table table-bordered" id="documents_collected_table_field">
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                  <input type="text" class="form-control" name="cp_one_father_name" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_father_name']:""; ?>">                                             
                                               </td>
                                               <td>
                                                  <input type="text" class="form-control" name="cp_one_mother_name" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_mother_name']:""; ?>"> 
                                               </td>
                                            </tr>
                                            <tr>
                                               <td style="text-align: left; font-weight: bold;">Phone No</td>
                                               <td>
                                                  <input type="text" class="form-control js-input-mobile" name="cp_one_father_mobile_no" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_father_mobile_no']:""; ?>">  
                                               </td>
                                               <td>
                                                  <input type="text" class="form-control js-input-mobile" name="cp_one_mother_mobile_no" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_mother_mobile_no']:""; ?>">  
                                               </td>
                                            </tr>
                                            <tr>
                                               <td style="text-align: left; font-weight: bold;">ID</td>
                                               <td>
                                                  <input type="text" class="form-control" name="cp_one_father_id" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_father_id']:""; ?>"> 
                                               </td>
                                               <td>
                                                  <input type="text" class="form-control" name="cp_one_mother_id" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_mother_id']:""; ?>"> 
                                               </td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="card-body">
                     <div class="form-group row">
                       <label class="col-xs-3 col-form-label">Name</label>
                       <div class="  col-xs-9">
                          <input type="text" class="form-control" placeholder="Name" name="cp_one_name" id="cp_one_name" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_name']:''?>">
                       </div>
                     </div>
                   ...
                   <div class="card-body">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Date of Birth (dd/mm/yyyy) <font color="red">*</font></label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control datepicker" data-date-end-date="0d" id="cp_two_dob" placeholder="Date of Birth" autocomplete="off" name="cp_two_dob" value="<?php echo !empty($incident_edit_details['cp_2_dob']) ? date('d-m-Y', strtotime($incident_edit_details['cp_2_dob'])) : ''; ?>" style="background-color: white;" readonly tabindex="7">
