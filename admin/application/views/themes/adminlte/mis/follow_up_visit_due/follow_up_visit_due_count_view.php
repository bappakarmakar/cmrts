...
<div class="content-wrapper">
  <section class="content-header" style="">
    <h1 style="margin-left: 35px;">Follow-up Visits Overdue
          ...
          <table id="table" class="table table-bordered table-striped">
            <thead>
              <tr class="custom_table_head">
                ...
                <th class="text-center">Visits Due</th>
            ...
            <tbody>
              ...
              $url_download = base_url() . "admin/mis/follow_up_visit_due/Follow_up_visit_due_report/excel_download_for_count_details?segregate=" . $segregate . "&from_date=" . $from_date_val . "&to_date=" . $to_date_val . "&unique_id=" . $unique_id_val . "&flag=" . $flag . "&check_ward_gp=" . $check_ward_gp . "&block_id=" . $block_id;
