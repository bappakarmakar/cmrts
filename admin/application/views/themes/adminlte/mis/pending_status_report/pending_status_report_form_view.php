...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <?php echo form_open('admin/mis/pending_status_report/pending_status_report_view', array('class' => 'PendingStatusReportForm','name' => 'PendingStatusReportForm', 'id' => 'PendingStatusReportForm')) ?>
      <div class="box bottom-box">
         <div class="box-body">
            <div class="card-body">
              <?php $currentDate_conv = date('Y/m/d'); ?>
              <?php $currentDate = date('d/m/Y'); ?>
              <?php //$currentDate = '2023/12/13'; ?>
         ...
         <button type="submit" name="pending_report_sub" class="btn btn-primary" style="margin-left: 8px;"><i class="fa fa-search" aria-hidden="true"></i> Search</button>
      </div>
      <?php echo form_close();?>
               ...
               <table id="table" class="table table-bordered table-striped">
                ...
                <?php 
                    ...
                    if($stake_id_fk==4){
                      ...
                      $download_excel_link = base_url()."admin/mis/pending_status_report/pending_status_report_view/SD_Block_Wise_Download_Excel/".$district_id."/".$date_raw_from."/".$date_raw_to;

                    }elseif($stake_id_fk == '1' || $stake_id_fk == '5'){ 
                      if(empty($district_id)){
                        $download_excel_link = base_url()."admin/mis/pending_status_report/pending_status_report_view/District_Wise_Download_Excel/".$date_raw_from."/".$date_raw_to;
                      }else{
                        $download_excel_link = base_url()."admin/mis/pending_status_report/pending_status_report_view/SD_Block_Wise_Download_Excel/".$district_id."/".$date_raw_from."/".$date_raw_to;
                      }
                  ...
                  <a href="<?=$download_excel_link?>" class="btn btn-success" style="margin-bottom: 15px;"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel</a>
                 <thead>
                       ...
                       <td style="text-align: left;">
                        <?php 
                          ...
                          if($stake_id_fk==4){
                            ...
                            $url = base_url()."admin/mis/pending_status_report/pending_status_report_view/ward_gp/".$value['block_id_pk']."/".$date_raw_from."/".$date_raw_to;
                            $district_name = $value['block_name'];

                          }elseif($stake_id_fk == '1' || $stake_id_fk == '5'){ 
                            $url = base_url()."admin/mis/pending_status_report/pending_status_report_view/sd_block/".$value['district_id_pk']."/".$date_raw_from."/".$date_raw_to;
