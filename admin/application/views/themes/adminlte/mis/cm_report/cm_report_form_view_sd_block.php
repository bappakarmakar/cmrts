...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <!-- <li><a href="<?php echo base_url();?>admin/mis/cm_report/cm_report_view?from_date=<?=$from_date;?>&to_date=<?=$to_date?>"><i class="fa fa-backward faico"></i>&nbsp;Back</a></li> -->
        <li><a href="<?php echo base_url();?>admin/mis/cm_report/cm_report_view"><i class="fa fa-backward faico"></i>&nbsp;Back</a></li>
         ...
         <div class="box-body">
            <div class="card-body">
               <table class="table table-bordered table-hover" id="table">
                  <a href="<?php echo base_url()?>admin/mis/cm_report/cm_report_view/SD_Block_Wise_Download_Excel/<?php echo $district_id; ?>/<?php echo $from_date; ?>/<?php echo $to_date; ?>" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel</a>
                 <thead>
                 ...
                 <tbody id="childAppend">
                    ...
                    $before_marriage_prevented_total_count = +$value['before_marriage_prevented'];
                    $during_marriage_prevented_total_count = +$value['during_marriage_prevented'];
                    //echo $before_marriage_prevented_total_count;die;
                    ?>
                    <tr>
                       <td><?php echo $c++;?></td>
                       <td style="text-align: left;"><a href="<?php echo base_url()?>admin/mis/cm_report/cm_report_view/ward_gp/<?php echo $value['block_id_pk']; ?>/<?php echo $from_date; ?>/<?php echo $to_date; ?>"><?php echo $value['block_name']; ?></a></td>
