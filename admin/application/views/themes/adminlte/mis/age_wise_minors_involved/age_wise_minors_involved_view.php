                       ...
                       <td><?php echo $c++; ?></td>
                        ...
                        <?php 
                          if($stake_id_fk==4){
                            ...
                            $url = base_url()."admin/mis/age_wise_minors_involved/age_wise_minors_involved_view/ward_gp/".$value['block_id_pk']."/".$date_raw_from."/".$date_raw_to;
                            $district_name = $value['block_name'];
                    ...
                    if(count($report_result)>1)
                    {
                      ...
                      <tfoot>
                        <tr class="custom_table_head">
                          ...
                          <td><?php echo (array_sum(array_column($report_result, 'female_count_under_12')) + array_sum(array_column($report_result, 'female_count_12_13')) +
