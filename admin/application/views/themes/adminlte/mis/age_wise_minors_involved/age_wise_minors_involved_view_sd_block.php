...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin/mis/age_wise_minors_involved/age_wise_minors_involved_view"><i class="fa fa-backward faico"></i>&nbsp;Back</a></li>
         ...
         <div class="box-body">
            <div class="card-body">
               <table id="table" class="table table-bordered table-striped">
                  <a href="<?php echo base_url()?>admin/mis/age_wise_minors_involved/age_wise_minors_involved_view/SD_Block_Wise_Download_Excel/<?php echo $district_id; ?>/<?php echo $from_date; ?>/<?php echo $to_date; ?>" class="btn btn-success" style="margin-bottom: 15px;"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel</a>
                 <thead>
                 ...
                 <tbody id="childAppend">
                    ...
                    <tr>
                       <td><?php echo $c++; ?></td>
                       <td style="text-align: left;"><a href="<?php echo base_url()?>admin/mis/age_wise_minors_involved/age_wise_minors_involved_view/ward_gp/<?php echo $value['block_id_pk']; ?>/<?php echo $from_date; ?>/<?php echo $to_date; ?>"><?php echo $value['block_name']?></a></td>
                       ...
                       <td><?php if($value['male_count_16_17']){ echo $value['male_count_16_17']; } else { echo "0"; } ?></td>

                       <td><?php if($value['female_count_17_18']){ echo $value['female_count_17_18']; } else { echo "0"; } ?></td>
                       <td><?php if($value['male_count_17_18']){ echo $value['male_count_17_18']; } else { echo "0"; } ?></td>
                    ...
                    if(count($report_result)>1)
                    {
                      ...
                      <tfoot>
                        <tr class="custom_table_head">
                          ...
                          <td><?php echo (array_sum(array_column($report_result, 'female_count_under_12')) + array_sum(array_column($report_result, 'female_count_12_13')) + array_sum(array_column($report_result, 'female_count_13_14')) + array_sum(array_column($report_result, 'female_count_14_15'))+ array_sum(array_column($report_result, 'female_count_15_16')) + array_sum(array_column($report_result, 'female_count_16_17')) + array_sum(array_column($report_result, 'female_count_17_18')) ) ;
                              ?>
                          </td>
                          <td><?php echo (array_sum(array_column($report_result, 'male_count_under_12')) + array_sum(array_column($report_result, 'male_count_12_13'))+
