         ...
         <div class="box-body">
            <div class="card-body">
               <table id="table" class="table table-bordered table-striped">
                  <a href="<?php echo base_url()?>admin/mis/age_wise_minors_involved/age_wise_minors_involved_view/GP_Ward_Wise_Download_Excel/<?php echo $block_id; ?>/<?php echo $from_date; ?>/<?php echo $to_date; ?>" class="btn btn-success" style="margin-bottom: 15px;"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel</a>
                 <thead>
