...
<div class="content-wrapper">
  <section class="content-header" style="">
    <h1 style="margin-left: 35px;">Home Enquiry(adult) Overdue
        ...
        <div class="card-body " style="padding: 8px">
          ...
          <table id="table" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $url_download = base_url() . "admin/mis/home_enquiry_overdue_adult/Home_enquiry_adult_overdue/excel_download_for_count_details?segregate=" . $segregate . "&from_date=" . $from_date_val . "&to_date=" . $to_date_val . "&unique_id=" . $unique_id_val . "&flag=" . $flag . "&check_ward_gp=" . $check_ward_gp . "&block_id=" . $block_id;
