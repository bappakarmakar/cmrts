...
<div class="content-wrapper">
   <section class="content-header">
      ...
      $form_action = 'admin/mis/home_enquiry_overdue_adult/Home_enquiry_adult_overdue/home_enquiry_adult_overdue_report';
      echo "<h1>" . $title . "</h1>";
      ?>
               ...
               <table id="table" class="table table-bordered table-striped">
                  ...
                  <tbody id="childAppend">
                     ...
                     if ($force_view == 1) {
                        ...
                        $url_download = base_url() . "admin/mis/home_enquiry_overdue_adult/Home_enquiry_adult_overdue/download_excel?segregate=" . $segregate . "&from_date=" . $from_date_val . "&to_date=" . $to_date_val . "&unique_id=" . $unique_id_val;
                     ...
                     ?>
                           <?php foreach ($report_result as $value) {
                              ...
                              if ($segregate != "ward_gp") {
                                 $url = base_url() . "admin/mis/home_enquiry_overdue_adult/Home_enquiry_adult_overdue/home_enquiry_adult_overdue_report?segregate=" . $segregate . "&from_date=" . $from_date . "&to_date=" . $to_date . "&unique_id=" . $value['unique_id'];
                              }
                           ?>
                              ...
                              $url_count = base_url() . "admin/mis/home_enquiry_overdue_adult/Home_enquiry_adult_overdue/home_enquiry_adult_overdue_report_countwise?segregate=" . $segregate . "&from_date=" . $from_date . "&to_date=" . $to_date . "&unique_id=" . $value['unique_id'] . "&block_id=" . $block_id . "&check_ward_gp=" . $gp_ward . "&flag=" . " ";
                              ?>
                              <tr>
                                 <td><?php echo $c++; ?></td>
                  ...
                  <tfoot>
                     <tr class="custom_table_head">
                        <td colspan="2"><center><center><b> Total </b> </center></td>
