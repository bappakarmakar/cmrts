<?php //echo $this->session->userdata('stake_id_fk').'--'.$this->session->userdata('block').'</br>';
//echo "<pre>"; print_r($district_details); ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <link rel="stylesheet" href="<?php echo $this->config->item('theme_uri');?>assets/css/select2.min.css" />
...
<!--            <li style="margin-right: 5px;">
            <a class="btn btn-danger" style="padding: 12px;margin-top: 2px;" href="<?php echo base_url('admin/tutorials/tutorials');?>" >
               <i class="fa fa-play-circle" aria-hidden="true"></i> Watch Tuturials
            </a>
            </li>
            <li>
