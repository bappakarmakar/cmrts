...
<div class="vid-slider">
    ...
    <div class="col-md-4">
<div class="vid item">
    <img src="<?php echo base_url('admin/files/tutorials/video/img/cover.jpg');?>" style="width: ;">
    
<iframe autoplay="false muted
    " id="myIframe" width="100%" height="250px" src="<?php echo base_url('admin/files/tutorials/video/compressed/TV1 How to log in.mp4');?>" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<h2 class="vid-head">How to log in</h2>
</div> 
</div> 
 <div class="col-md-4">
<div class="vid item">
<iframe width="100%" muted height="250px" src="<?php echo base_url('admin/files/tutorials/video/compressed/TV2 How to Change your Password.mp4');?>" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" control allowfullscreen></iframe>
<h2 class="vid-head">How to Change your Password</h2>
</div>
</div>
<div class="col-md-4">
<div class="vid item">
<iframe width="100%" muted height="250px" src="<?php echo base_url('admin/files/tutorials/video/compressed/TV3 How to Add an Intervention Report.mp4');?>" frameborder="0" allow="accelerometer;  encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
