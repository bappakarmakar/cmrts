...
<div class="content-wrapper">
   <section class="content-header">
      <h1>Unpublished Followup visit Report</h1>
      <ol class="breadcrumb">
   ...
   <section class="content">
      ...
      ?>
      <?php echo form_open('admin/mis/unpublished_followup_visit_report/unpublished_followup_visit_report', array('class' => 'EducationReportForm','name' => 'EducationReportForm', 'id' => 'EducationReportForm')) ?>
                 ...
                 <thead>
                  ...
                  if($force_view == 1){
                    ...
                    $unique_id_val = isset($_GET['unique_id']) ? $_GET['unique_id'] : (isset($unique_id) ? $unique_id : null);
                     ...
                     $url_download = base_url()."admin/mis/unpublished_followup_visit_report/unpublished_followup_visit_report/download_excel?segregate=".$segregate."&from_date=".$from_date_val."&to_date=".$to_date_val."&unique_id=".$unique_id_val;
                  ...
                  {  
                    ...
                    <?php foreach ($report_result as $value) 
                    {
                      ...
                      {
                        $url = base_url()."admin/mis/unpublished_followup_visit_report/unpublished_followup_visit_report?segregate=".$segregate."&from_date=".$from_date."&to_date=".$to_date."&unique_id=".$value['unique_id'];
                      }
