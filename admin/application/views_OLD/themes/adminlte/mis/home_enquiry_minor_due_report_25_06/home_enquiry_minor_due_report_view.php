                 ...
                 <thead>
                  ...
                  { 
                    ...
                    <?php foreach ($report_result as $value) 
                    {
                      ...
                      <td><?= ($value['total_due'] != 0)?($value['total_due']):0 ;?></td>
                      <td><?= ($value['pending_1_7_days'] != 0)?($value['pending_1_7_days']):0 ;?></td>
                      <td><?= ($value['pending_8_15_days'] != 0)?($value['pending_8_15_days']):0 ;?></td>
                      <td><?= ($value['pending_16_30_days'] != 0)?($value['pending_16_30_days']):0 ;?></td>
                      <td><?= ($value['pending_31_60_days'] != 0)?($value['pending_31_60_days']):0 ;?></td>
                      <td><?= ($value['pending_61_90_days'] != 0)?($value['pending_61_90_days']):0 ;?></td>
                      <td><?= ($value['pending_above_90_days'] != 0)?($value['pending_above_90_days']):0 ;?></td>
                  ...
                  <tfoot>
                    <tr class="custom_table_head">
                      ...
                      <td><?php echo array_sum(array_column($report_result, 'total_due'));?></td>
                      <td><?php echo array_sum(array_column($report_result, 'pending_1_7_days'));?></td>
                      <td><?php echo array_sum(array_column($report_result, 'pending_8_15_days'));?></td>
                      <td><?php echo array_sum(array_column($report_result, 'pending_16_30_days'));?></td>
                      <td><?php echo array_sum(array_column($report_result, 'pending_31_60_days'));?></td>
                      <td><?php echo array_sum(array_column($report_result, 'pending_61_90_days'));?></td>
                      <td><?php echo array_sum(array_column($report_result, 'pending_above_90_days'));?></td>
<!--  -->
