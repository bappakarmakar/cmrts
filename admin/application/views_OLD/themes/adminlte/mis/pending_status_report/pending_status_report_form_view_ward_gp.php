         ...
         <div class="box-body">
            <div class="card-body">
               <table id="table" class="table table-bordered table-striped">
                  <a href="<?php echo base_url()?>admin/mis/pending_status_report/pending_status_report_view/GP_Ward_Wise_Download_Excel/<?php echo $block_id; ?>/<?php echo $from_date; ?>/<?php echo $to_date; ?>" class="btn btn-success" style="margin-bottom: 15px;"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel</a>
                 <thead>
                    <tr class="custom_table_head">
                       <th class="text-center" rowspan="2">Sl. No</th>
                       <th class="text-center" rowspan="2">GP Name / Ward No</th>
                 ...
                 <tbody id="childAppend">
                    ...
                    <tr>
                       <td><?php echo $c++; ?></td>
                       <td><?php echo $value['ward_gp_name']?></td>
                       ...
                       <td><?php if($value['bdo_sdo_level_not_publish_count'] != 0){ echo $value['bdo_sdo_level_not_publish_count']; } else { echo "0"; } ?></td>
                       <!-- <td>0</td> -->
