...
<script>
  ...
  // Back Button js Code 23.12.2024 Start  
  function previous(url) {
    ...
    console.log("temp_url_val:", temp_url_val, "Length:", temp_url_val.length);
    console.log("previous_history_url:", previous_history_url, "Length:", previous_history_url.length);
  ...
  // Back Button js Code 23.12.2024 End
</script>
