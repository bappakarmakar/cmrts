...
<div class="content-wrapper">
   <section class="content-header">
    <!-- <?php echo "----".$this->session->userdata('stake_id_fk'); ?> -->
            ...
            <table class="table table-bordered table-hover" id="mytable">
               ...
               <tbody id="childAppend">
                  ...
                  <tr> 
                     ...
                     <!-- <td><?php echo $value->cp_age_months; ?></td> -->
                     ...
                     <!-- <td><?php echo $value->age_of_home_enquiry; ?></td> -->
                      ...
                      <td><?php get_full_year_HE_FUV($value->home_enquiry_date, $value->cp_dob); ?></td>
...
// Delete Record 
 ...
 function Delete_homeVisit(cp_id_fk) {
    // alert(cp_id_fk);
    swal({
        title: "Delete?",
        type: "warning",
