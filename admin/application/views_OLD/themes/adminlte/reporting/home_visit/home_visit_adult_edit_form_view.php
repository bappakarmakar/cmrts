...
?>
<?php echo form_open('admin/reporting/incident/incident_list/home_visit_adult_form/edit/'.base64_encode($home_visit_sl_no), array('class' => 'home_visit_adult_edit_form', 'name' => 'home_visit_adult_edit_form', 'id' => 'home_visit_adult_edit_form'))?>
               ...
               <div class="card-body p-0">
                  ...
                  <div class="form-group">
                     <div class="box-body">
                        <div class="row">
                           ...
                           <div class="col-sm-2">
                              <input type="radio" name="family_income" value="1" <?=($home_visit_details['family_income']==1)?'checked':''?>>
                           </div>
                           <div class="col-sm-2">
                              <input type="radio" name="family_income" value="2" <?=($home_visit_details['family_income']==2)?'checked':''?>>
                           </div>
                           <div class="col-sm-2">
                              <input type="radio" name="family_income"  value="3" <?=($home_visit_details['family_income']==3)?'checked':''?>>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     <div class="box-body">
                        <div class="row">
                           ...
                           <div class="col-sm-2">
                              <input type="radio" name="emergencies" id="emergencies" value="1" <?=($home_visit_details['emergencies']==1)?'checked':''?>>
                           </div>
                           <div class="col-sm-2">
                              <input type="radio" name="emergencies" id="emergencies" value="2" <?=($home_visit_details['emergencies']==2)?'checked':''?>>
                           </div>
                           <div class="col-sm-2">
                              <input type="radio" name="emergencies" id="emergencies" value="3" <?=($home_visit_details['emergencies']==3)?'checked':''?>>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="box-body">
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-12">    
                              <label class="badge badge-primary text-wrap " style="width: 50rem; font-size:medium;">At time of Home Enquiry, was the contraction party engaged in&nbsp;<font color="red">*</font></label>   
                           ...
                           <div class="col-sm-6">
                              ...
                              <table class="table table-bordered" id="documents_collected_table_field">
                                 ...
                                 <tr class="education_data">
                                    <td><input type="radio" name="education_frequency" class="education_frequency" value="1" <?=($home_visit_details['education_frequency']==1)?'checked':''?>></td>

                                    <td><input type="radio" name="education_frequency" class="education_frequency"  value="2" <?=($home_visit_details['education_frequency']==2)?'checked':''?>></td>

                                    <td id="education_frequency"><input type="radio" name="education_frequency" class="education_frequency"  value="3" <?=($home_visit_details['education_frequency']==3)?'checked':''?>></td>
                                 </tr>
                                 <tr class="paid_work_data">
                                    <td><input type="radio" name="paid_work_frequency" class="paid_work_frequency" value="1" <?=($home_visit_details['paid_work_frequency']==1)?'checked':''?>></td>

                                    <td><input type="radio" name="paid_work_frequency" class="paid_work_frequency" value="2" <?=($home_visit_details['paid_work_frequency']==2)?'checked':''?>></td>

                                    <td id="paid_work_frequency"><input type="radio" name="paid_work_frequency" class="paid_work_frequency" value="3" <?=($home_visit_details['paid_work_frequency']==3)?'checked':''?> ></td>
                                 </tr>
                              </table>
                           </div>
                        </div>
...
<script type="text/javascript">
   $(document).ready(function(){
     var homeVisitSlNo = $("input[name='home_visit_sl_no']").val();
      ...
      $(document).off('submit', '#home_visit_adult_edit_form').on('submit', '#home_visit_adult_edit_form', function (event) {
         event.preventDefault();
         var csrf_token_value = $('input[name=csrf_cmrts]').val();
         var formName = 'home_visit_adult_edit_form';
         var formData = new FormData($('form[name="' + formName + '"]')[0]);
         formData.append("csrf_cmrts", csrf_token_value);
         formData.append("action", "submit");
         $.ajax({
            type: 'POST',
             url: '<?php echo base_url()?>admin/reporting/home_visit/Home_visit_adult_form/edit_from_update/',
             data: formData,
             processData: false,
             cache: false,
             contentType: false,
