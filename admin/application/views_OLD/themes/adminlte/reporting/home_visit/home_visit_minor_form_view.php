...
?>
<?php echo form_open('admin/reporting/incident/incident_list/home_visit_minor_form/'.$record_num_1.'/'.$record_num_2.'/'.$record_num_3, array('class' => 'home_visit_minor_form', 'name' => 'home_visit_minor_form', 'id' => 'home_visit_minor_form'))?>
                                       ...
                                       <div class="col-md-9">
                                          <div class="name-add-section" style="width: 60%;">
                                             ...
                                             <div class="" style="border-bottom: 1px solid #0002;padding-bottom: 5px;padding-top: 5px;">
                                              ...
                                              <div class="" style="border-bottom: 1px solid #0002;padding-bottom: 5px;padding-top: 5px;">
                                                 <label style=""><b>Date of Birth :</b></label><?php echo $incident_cp_details->cp_dob; ?>
