...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <div class="box bottom-box">
         <?php echo form_open('admin/reporting/incident/incident_list/child_welfare_committee_proceedings_cp_one_form/'.$record_num, array('class' => 'AddressChangeForm','name' => 'AddressChangeForm', 'id' => 'AddressChangeForm')) ?>
