...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      ?>
      <?php echo form_open('admin/reporting/police_case/police_case_list/edit/'.base64_encode($police_case_details->sl_no).'/'.$record_num, array('class' => 'PoliceCaseForm','name' => 'PoliceCaseForm', 'id' => 'PoliceCaseForm')) ?>
      ...
      <div class="box bottom-box">
         <div class="box-body">
            <div class="card-body">
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                   <input type="text" name="gd_no" id="gd_no" class="form-control" autocomplete="off" placeholder="GD No" value="<?=$police_case_details->gd_no?>">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                   <input type="text" class="form-control datepicker" data-date-end-date="0d" id="gd_date" placeholder="GD Date" readonly autocomplete="off" name="gd_date" style="background-color: white;" tabindex="7" value="<?php echo date('d/m/Y', strtotime($police_case_details->gd_date)); ?>">
         ...
         <div class="box-body">
            <div class="card-body">
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                   <input type="text" name="fir_no" id="fir_no" class="form-control" autocomplete="off" placeholder="FIR No" value="<?php echo $police_case_details->fir_no; ?>">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                   <input type="text" class="form-control datepicker" data-date-end-date="0d" id="fir_date" placeholder="FIR Date" readonly autocomplete="off" name="fir_date" style="background-color: white;" tabindex="7" value="<?php echo date('d/m/Y', strtotime($police_case_details->fir_date)); ?>">
         ...
         <div class="box-body">
            <div class="card-body">
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                   <input type="text" name="police_station" id="police_station" class="form-control" autocomplete="off" placeholder="Police Station" value="<?php echo $police_case_details->police_station; ?>">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                   <select class="form-control" name="pc_district" id="pc_district">
                     ...
                     <option value="<?php echo $district['district_id_pk'];?>" <?php if($police_case_details->district == $district['district_id_pk']){ echo "selected"; } ?>><?php echo $district['district_name'];?></option>
                     <?php } ?>                     
                   </select>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-6">
                     <select class="form-control" name="pc_block" id="pc_block">
                        <?php foreach($Block as $BlockValue){?>
                        <option value="<?php echo $BlockValue['block_id_pk'];?>" <?php if($BlockValue['block_id_pk'] == $police_case_details->block){ echo "selected"; }?>><?php echo $BlockValue['block_name'];?></option> 
                        <?php } ?>
                     </select>
                 ...
                 <div class="col-sm-6">
                   <select class="form-control" name="reason">
                     ...
                     <?php foreach($reason as $value){?>
                      <option value="<?=$value->sl_no?>" <?php echo set_select('reason', $value->sl_no, False); ?> <?=($police_case_details->reason==$value->sl_no)?'selected':''?> ><?=$value->description?></option>
                     <?php } ?>
         ...
         <div class="box bottom-box" style="text-align: center;">
            <button type="submit" class="btn btn-primary"><i class="fa fa-paper-plane" aria-hidden="true"></i> Update</button>
         </div>
      </div>
      <?php echo form_close();?>
   </section>
