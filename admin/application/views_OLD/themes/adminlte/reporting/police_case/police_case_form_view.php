...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <?php echo form_open('admin/reporting/incident/incident_list/police_cases/'.base64_encode($incident_id).'/'.base64_encode($cp_id).'/'.base64_encode($cp_type), array('class' => 'PoliceCaseForm','name' => 'PoliceCaseForm', 'id' => 'PoliceCaseForm')) ?>
       ...
       <?php //echo form_open('admin/reporting/incident/incident_list/police_cases', array('class' => 'PoliceCaseForm','name' => 'PoliceCaseForm', 'id' => 'PoliceCaseForm')) ?>
      ...
      <div class="box bottom-box">
         <div class="box-body">
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Intervention Number <font color="red">*</font></label>
                <div class="col-sm-6">
                  <!-- <select class="form-control" name="police_station" id="police_station">
                    <option value="">--Please Select Intervention No--</option>
                  </select> -->
                  <input type="text" name="intervention_no" id="intervention_no" class="form-control" autocomplete="off" placeholder="Enter Intervention Id" >
                </div>
                <!-- <div class="col-md-2">
         ...
         <div class="box-body">
          ...
          <div class="box-body">
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Person/s Filing complaint <font color="red">*</font></label>
                <div class="col-sm-6">
                  <textarea class="form-control" name="filing_complaint" id="filing_complaint" ></textarea>
                </div>
              </div>

              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Person/s Accused <font color="red">*</font></label>
                <div class="col-sm-6">
                  <textarea class="form-control" name="person_accused" id="person_accused"></textarea>
                </div>
              </div>

              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Description of complaint <font color="red">*</font></label>
                <div class="col-sm-6">
         ...
         <div class="box bottom-box" style="text-align: center;">
            ...
            <button type="submit" class="btn btn-danger"><i class="fa fa-paper-plane" aria-hidden="true"></i> Cancel</button>
