                        ...
                        <div class="dropdown" style="">
                          ...
                          <ul class="dropdown-menu action_menu" role="menu" aria-labelledby="menu1" style="margin-left: -83px;">
                            ...
                            if($stake_id_fk=='4' && $block==$value->current_block){ ?>
                              ...
                              ?>
                                <li role="presentation"><a role="menuitem" tabindex="-1" onclick="address_change_action('<?php echo base64_encode($value->address_change_id_pk); ?>' ,'delete') "><i class="fa fa-address-card" aria-hidden="true"></i>Delete</a></li>
                              ...
                              ?>
                                ...
                                <li role="presentation"><a role="menuitem" tabindex="-1" onClick="address_change_action('<?php echo base64_encode($value->address_change_id_pk); ?>', 'forward')"><i class="fa fa-forward"></i>Forward</a></li>
                              <?php } ?>
                            ...
                            <?php if(($stake_id_fk=='2' || $stake_id_fk=='6') && $block == $value->current_block ){ ?>
                              <?php if($value->current_status=='2' ){ ?>
                                ...
                                <li role="presentation"><a role="menuitem" tabindex="-1" onClick="address_change_action('<?php echo base64_encode($value->address_change_id_pk); ?>', 'revert')"><i class="fa fa-forward"></i>Revert</a></li>
            ...
            <div class="col-md-6" id='for_west_bengal'>
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <select class="form-control" id='district' name='district' onchange="select_district($(this).val())">
            ...
            <div class="col-md-6" id="block_div">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <select class="form-control" id='block_municipal' name='block_municipal' onchange="select_block_municipal($(this).val())">
...
<script type="text/javascript">
  ...
  function select_district(district_id=null)
  {
    var url = '<?php echo base_url()?>admin/reporting/incident/Incident_list/get_block_municipality/';
    $.ajax({
        url: url,
  ...
  function select_block_municipal(block=null){
  ...
  function address_change_action(address_change_id, actionType){
    ...
    function(isConfirm){
        if(isConfirm) {
            ...
            $.ajax({
                url: url,
                method: "GET",
                data: {'address_change_id': address_change_id, 'action': actionType},
                dataType: "JSON",
