...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <div class="box bottom-box">
         <?php echo form_open('admin/reporting/incident/incident_list/address_change/'.base64_encode($incident_details[0]->incident_id_pk), array('class' => 'AddressChangeForm','name' => 'AddressChangeForm', 'id' => 'AddressChangeForm')) ?>
                  ...
                  <div class="card-body p-0">
                     <div class="box-body">
                        <div class="card-body">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-9">
                                 <?php if($this->session->userdata('stake_id_fk') == '2' || $this->session->userdata('stake_id_fk') == '6'){?> 
                                 <label class="radio-inline"><input type="radio" class="minor_details_div" name="minor_details" id="minor_details" data-id="<?php echo $incident_details[0]->incident_id_pk?>" value="1" <?php echo set_radio('minor_details', 1); ?>>&nbsp;Contracting Party One</label>&nbsp;&nbsp;
                                
                                 <label class="radio-inline"><input type="radio" class="minor_details_div" name="minor_details" id="minor_details" data-id="<?php echo $incident_details[0]->incident_id_pk?>" value="2" <?php echo set_radio('minor_details', 2); ?>>&nbsp;Contracting Party Two</label>&nbsp;&nbsp;
                                 <?php } ?>
                     ...
                     <div class="box-body CWC_Second_Row">
                        <div class="card-body CWC_Address_Div">
                           <div class="form-group row">
                             <label class="col-sm-2 col-form-label">Street / Landmark <font color="red">*</font></label>
                             <div class="col-sm-6">
                                 <input type="text" class="form-control" id="address" autocomplete="off" name="address" placeholder="Street / Landmark" value="<?php echo set_value('address'); ?>">
                        ...
                        <div class="card-body CWC_Address_Div">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <input type="text" class="form-control" id="address" autocomplete="off" name="address" placeholder="Pin Code" value="<?php echo set_value('address'); ?>">
                                 <?php echo form_error('address'); ?>
                             </div>
                           </div>
                        </div>
                        <div class="card-body CWC_Address_Div">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-6">
                                 <input type="text" class="form-control" id="address" autocomplete="off" name="address" placeholder="Police Station" value="<?php echo set_value('address'); ?>">
                                 <?php echo form_error('address'); ?>
                             </div>
                           </div>
                        </div>
