...
<div class="content-wrapper">
   ...
   <?php
   if($_POST){
   $reporting_id = set_value('hid_incident_maxid');
   ...
   $reporting_id = ($incident_edit_details)?$incident_edit_details['reporting_id']:'';
   ...
   <section class="content-header">
      <?php //echo $validation_error_count; ?>
      <h1>Intervention Draft Report</h1>
      <ol class="breadcrumb">
   ...
   <section class="content">
      <div class="box bottom-box container">
         <!-- <form action="reporting/incident/incident_form/" id="incident_form" class="incident_form" name="incident_form" method="post"> -->
         <?php echo form_open('admin/reporting/incident/incident_form/update_draft_incident/'.base64_encode($incident_id), array('class' => 'incident_form_edit','name' => 'incident_form_edit', 'id' => 'incident_form_edit')) ?>
         <input type="hidden" id="hid_incident_maxid" name="hid_incident_maxid" value="<?php echo $reporting_id; ?>">
         <div class="tab-content">
            ...
            <div id="home" class="tab-pane fade in active">
               <div class="card-body">
                  ...
                  <div class="form-group row">
                     <label class="col-sm-12 col-form-label badge badge-Primary text-wrap " style="width: 19rem; font-size:medium;">Prevention Intervention</label>
                  </div>
               </div>
               <div class="card-body">
                  <div class="row">
                  ...
                  <div class="form-group row">
                     <label class="col-sm-4 col-form-label">Date of intervention&nbsp;(dd/mm/yyyy) <font color="red">*</font></label>
                     <div class="col-sm-8">
                        <input type="text" class="form-control datepicker_inc_date" data-date-end-date="0d" id="incident_date" placeholder="Intervention Date" readonly autocomplete="off" name="incident_date" value="<?=$incident_date; ?>" style="margin-left: 29px; background-color: white;" tabindex="7">
                  ...
                  <div class="form-group row">
                     <label class="col-sm-4 col-form-label d-flex">Date of marriage&nbsp;(dd/mm/yyyy)<font color="red" id="font-str">*</font></label>
                     <div class="col-sm-8">
                        <div class="d-flex">
                           <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="Marriage Date" readonly autocomplete="off" name="marriage_date" value="<?=$marriage_date; ?>" style="margin-left: 29px; background-color: white;" tabindex="7" >
                           <div style="margin-left: 29px;">
                            </div>
                           
                           <div class="trash-icon">
                              <button type="button" class="btn btn-danger" id="trash" onclick="clear_marriage_date()"><i class="fa fa-trash" aria-hidden="true"></i></button>
                           </div>
                        </div>
                        <span id="marriage_date_error" style="color: red;margin-left: 29px;"></span>
                        <div style="margin-left: 29px;">
                     ...
                     <div class="col-sm-3">
                        ...
                        <div class="right_marriage_details" style="text-align: right;">
                           ...
                           <?php
                              $marriage_details_val='';
                              if(set_value('marriage_details'))
                              {
                                 $marriage_details_val=set_value('marriage_details');
                              }
                              elseif($incident_edit_details['marriage_details'])
                              {
                                 $marriage_details_val = $incident_edit_details['marriage_details'];
                              }
                              else
                              {
                                 $marriage_details_val = null;
                              }
                           ...
                           ?>
                           <span style="<?php echo $marriage_details_css; ?>"><?php echo $value['description']?></span>&nbsp;&nbsp;<input type="radio" name="marriage_details" class="marriage_details_check" id="marriage_details" value="<?php echo $value['cm_marriage_master_id_pk']?>" <?php echo $marriage_details_val==$value['cm_marriage_master_id_pk']?'checked':'';?> style="float: right;margin-right: 00px;">&nbsp; <br>
                           <?php } ?>
                  ...
                  <div class="form-group row"style="margin-bottom: 0;">
                     ...
                     <div class="col-sm-3">
                          <fieldset class="scheduler-border">
                           <legend class="scheduler-border"><font color="red" size="5px">*</font></legend>
                        <div class="prevented_details" style="text-align: right;">
                           <?php 
                              $prevented_details_val='';
                              if(set_value('prevented_details'))
                              {
                                 $prevented_details_val=set_value('prevented_details');
                              }
                              elseif($incident_edit_details['prevented_details'])
                              {
                                 $prevented_details_val = $incident_edit_details['prevented_details'];
                              }
                           ...
                           <input type="radio" name="prevented_details" id="prevented_details_<?=$key?>" value="<?php echo $value['cm_incident_report_details_master_id_pk']?>" <?php echo set_radio('prevented_details', $value['cm_incident_report_details_master_id_pk']); ?> <?php echo $prevented_details_val== $value['cm_incident_report_details_master_id_pk']?'checked':'' ?> style="float: right;margin-right: 0px;"><br>
                           <?php } ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        ...
                        <select class="form-control" name="incident_block" id="incident_block"  style="cursor: not-allowed;">
                           ...
                           <option value="<?php echo $value['block_id_pk']; ?>" <?php echo set_select('incident_block', $value['block_id_pk'],$value['block_id_pk']==$incident_block); ?>><?php echo $value['block_name']; ?></option>
                           <?php } ?>
                        </select>
                        <?php }elseif($this->session->userdata('stake_id_fk') == '4' && $this->session->userdata('subdiv') != '')
                        {
                        ?>
                        <select class="form-control" name="incident_block" id="incident_block" readonly>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              $location_description_val='';
                              if(set_value('location_description'))
                              {
                                 $location_description_val=set_value('location_description');
                              }
                              elseif($incident_edit_details['location_description'])
                              {
                                 $location_description_val = $incident_edit_details['location_description'];
                              }
                           foreach($location_description_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="location_description" id="location_description" value="<?php echo $value['cm_location_master_id_pk']?>" <?php echo $location_description_val== $value['cm_location_master_id_pk']?'checked':'' ?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        ...
                        <?php
                         $anonymous_val='';
                           if(set_value('anonymous'))
                           {
                              $anonymous_val=set_value('anonymous');
                           }
                           elseif($incident_edit_details['anonymous'])
                           {
                              $anonymous_val = $incident_edit_details['anonymous'];
                           }
                        ?>
                        <label class="radio-inline">
                        <input type="radio" name="anonymous" class="anonymous" id="anonymous" value="1" <?php echo $anonymous_val==1?'checked':''?> >&nbsp;Yes</label>&nbsp;&nbsp;
                        <label class="radio-inline">
                        <input type="radio" name="anonymous" class="anonymous" id="anonymous" value="2" <?php echo $anonymous_val==2?'checked':''?>>&nbsp;No</label>&nbsp;&nbsp;
               ...
               <div class="card-body" id="Anonymous_2">
                  <div class="left-form">
                     ...
                     <div class="form-group row Information_Received">
                        ...
                        <div class="">
                           <?php 
                              $information_received_val='';
                              if(set_value('information_received'))
                              {
                                 $information_received_val=set_value('information_received');
                              }
                              elseif($incident_edit_details['information_received'])
                              {
                                 $information_received_val = $incident_edit_details['information_received'];
                              }
                              foreach($information_received_details as $value){?>
                           <div>
                              <?php echo $value['description']?>
                              &nbsp;&nbsp;&nbsp;
                              <input type="radio" class="inp-inf" name="information_received" id="information_received" value="<?php echo $value['cm_information_received_master_id_pk']?>" <?php echo $information_received_val==$value['cm_information_received_master_id_pk']?'checked':''?>>
                           </div>
                           <?php } ?>
            ...
            <div id="submenu2" class="tab-pane fade">
               <div class="card-body">
                  <div class="form-group row">
                     <label class="col-sm-12 col-form-label badge badge-Primary text-wrap " style="width: 41rem; font-size:medium;">Local Persons Involved in Prevention Intervention</label>
                  </div>
               </div>
               <div class="card-body">
            ...
            <div id="submenu3" class="tab-pane fade">
               <div class="card-body">
                  <div class="form-group row">
                     <label class="col-sm-12 col-form-label badge badge-Primary text-wrap " style="width: 38rem; font-size:medium;">Officials Involved in Prevention Intervention</label>
                  </div>
               </div>
               <div class="card-body">
                  <div class="form-group">
                           ...
                           <div class="col-sm-12">
                              <table class="table table-bordered" id="Officials_Involved_Table_Field">
                                 ...
                                 <tr class="Officials_Involved_Table_Remove" id="delete_officials_involved_row<?php if($this->input->post('Officials_Involved_Details')){ echo $key; ?><?php }else{?><?php echo $key; ?><?php } ?>">
                                    ...
                                    <td><input type="text" id="no" class="form-control officials_involved_contact_no_validate no" name="Officials_Involved_Details[<?php echo $key ?>][officials_involved_contact_no]" placeholder="Contact No" onkeyup="phone_number_validation()" maxlength="10" value="<?php echo $value['officials_involved_contact_no']; ?>" onpaste="return false"></td>
                                    <td>
            ...
            <div id="menu1" class="tab-pane fade">
               ...
               <div class="card-body">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                           <?php
                              $cp_one_state_val= NULL;
                              if(set_value('cp_one_state'))
                              {
                                 $cp_one_state_val=set_value('cp_one_state');
                              }
                              elseif($incident_edit_details['cp_1_state'])
                              {
                                 $cp_one_state_val = $incident_edit_details['cp_1_state'];
                              }
                           ?>
                        <select class="form-control cp_one_state_box" id="cp_one_state" autocomplete="off" name="cp_one_state">
                           <option value="0" disabled selected>--Select State--</option>
                           <?php foreach($state as $value){?>
                           <option value="<?php echo $value['state_id_pk']; ?>" <?php echo set_select('cp_one_state', $value['state_id_pk']); ?> <?= $cp_one_state_val==$value['state_id_pk']?'selected':''?>><?php echo $value['state_name']; ?></option>
                           <?php } ?>
                  ...
                  <div id="cp_one_address_div_two">
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Address <font color="red">*</font></label>
                           <?php
                              $cp_one_address_val= NULL;
                              if(set_value('cp_one_address'))
                              {
                                 $cp_one_address_val=set_value('cp_one_address');
                              }
                              elseif($incident_edit_details['cp_1_address'])
                              {
                                 $cp_one_address_val = $incident_edit_details['cp_1_address'];
                              }
                           ?>
                        <div class="col-sm-6">
                           <textarea class="form-control" name="cp_one_address" id="cp_one_address" rows="3" placeholder="Address"><?= $cp_one_address_val; ?> </textarea>
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              $cp_one_gender_val='';
                              if(set_value('cp_one_gender'))
                              {
                                 $cp_one_gender_val=set_value('cp_one_gender');
                              }
                              elseif($incident_edit_details['cp_1_gender'])
                              {
                                 $cp_one_gender_val = $incident_edit_details['cp_1_gender'];
                              }

                           foreach($gender_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" class="cp_one_gender_val" name="cp_one_gender" value="<?php echo $value['cm_gender_master_id_pk']?>" <?php echo $cp_one_gender_val==$value['cm_gender_master_id_pk']?'checked':''?> >&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              $cp_one_social_category_val='';
                              if(set_value('cp_one_social_category'))
                              {
                                 $cp_one_social_category_val=set_value('cp_one_social_category');
                              }
                              elseif($incident_edit_details['cp_1_social_category'])
                              {
                                 $cp_one_social_category_val = $incident_edit_details['cp_1_social_category'];
                              }
                           foreach($social_category_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="cp_one_social_category" value="<?php echo $value['cm_social_category_master_id_pk']?>" 
                                 <?php echo $cp_one_social_category_val==$value['cm_social_category_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              ...
                              elseif($incident_edit_details['cp_1_religion'])
                              {
                                 $cp_one_religion_val = $incident_edit_details['cp_1_religion'];
                              }

                           foreach($religion_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="cp_one_religion" value="<?php echo $value['cm_religion_master_id_pk']?>" 
                                 <?php echo $cp_one_religion_val==$value['cm_religion_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <input type="text" class="form-control datepicker_dob" data-date-end-date="0d" id="cp_one_dob" placeholder="Date of Birth" autocomplete="off" name="cp_one_dob" value="<?=$cp_one_dob; ?>" style="background-color: white;" readonly tabindex="7">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="cp_one_age_months" id="cp_one_age_months" autocomplete="off" placeholder="Age" value="<?php echo set_value('cp_one_age_months'); ?>" maxlength="2" readonly style="cursor: not-allowed;">

                        <input type="hidden" class="form-control js-input-mobile" name="cp_one_age" id="cp_one_age" autocomplete="off" placeholder="Age" value="<?=$cp_one_age; ?>" maxlength="2" readonly style="cursor: not-allowed;">

						<span id="cp_one_age_error" style="color: red;"></span>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                           <?php
                              $cp_one_dob_document_available_val='';
                              if(set_value('cp_one_dob_document_available'))
                              {
                                 $cp_one_dob_document_available_val=set_value('cp_one_dob_document_available');
                              }
                              elseif($incident_edit_details['cp_1_dob_document_available'])
                              {
                                 $cp_one_dob_document_available_val = $incident_edit_details['cp_1_dob_document_available'];
                              }
                           ?>
                           <label class="radio-inline">
                           <input type="radio" name="cp_one_dob_document_available" class="dob_document_cp_one" value="1"
                           <?php echo $cp_one_dob_document_available_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                           <label class="radio-inline">
                           <input type="radio" name="cp_one_dob_document_available" class="dob_document_cp_one" value="2" 
                           <?php echo $cp_one_dob_document_available_val==2?'checked':''?>>&nbsp;No</label>&nbsp;&nbsp;
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              ...
                              elseif($incident_edit_details['cp_1_dob_document_type'])
                              {
                                 $cp_one_dob_document_type_val = $incident_edit_details['cp_1_dob_document_type'];
                              }
                           foreach($document_type_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="cp_one_dob_document_type" value="<?php echo $value['cm_document_type_master_master_id_pk']?>" <?php echo $cp_one_dob_document_type_val==$value['cm_document_type_master_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <?php
                              $cp_one_identity_document_available_val='';
                              if(set_value('cp_one_identity_document_available'))
                              {
                                 $cp_one_identity_document_available_val=set_value('cp_one_identity_document_available');
                              }
                              elseif($incident_edit_details['cp_1_identity_document_available'])
                              {
                                 $cp_one_identity_document_available_val = $incident_edit_details['cp_1_identity_document_available'];
                              }
                        ?>
                        <label class="radio-inline">
                        <input type="radio" name="cp_one_identity_document_available" class="identity_document_cp_one" value="1" <?php echo $cp_one_identity_document_available_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                        <label class="radio-inline">
                        <input type="radio" name="cp_one_identity_document_available" class="identity_document_cp_one" value="2" <?php echo $cp_one_identity_document_available_val==2?'checked':''?>>&nbsp;No</label>&nbsp;&nbsp;
               ...
               <div class="card-body" id="identity_document_available_cp_one">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              $cp_one_identity_document_type_val='';
                              if(set_value('cp_one_identity_document_type'))
                              {
                                 $cp_one_identity_document_type_val=set_value('cp_one_identity_document_type');
                              }
                              elseif($incident_edit_details['cp_1_identity_document_type'])
                              {
                                 $cp_one_identity_document_type_val = $incident_edit_details['cp_1_identity_document_type'];
                              }
                           foreach($document_type_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="cp_one_identity_document_type" value="<?php echo $value['cm_document_type_master_master_id_pk']?>" <?php echo 
                              $cp_one_identity_document_type_val==$value['cm_document_type_master_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
                     ...
                     <div class="col-sm-9">
                        <div class="des-loc">
                           <?php 
                              ...
                              elseif($incident_edit_details['cp_1_highest_educational_attainment'])
                              {
                                 $cp_one_highest_educational_attainment_val = $incident_edit_details['cp_1_highest_educational_attainment'];
                              }
                           foreach($highest_education_details as $value){?>
                           <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="cp_one_highest_educational_attainment" value="<?php echo $value['cm_highest_educational_attainment_master_id_pk']?>" <?php echo $cp_one_highest_educational_attainment_val==$value['cm_highest_educational_attainment_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                           </div>
                           <?php } ?>
                        ...
                        <div class="col-sm-12">
                           <table class="table table-bordered" id="documents_collected_table_field">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_father_mobile_no" id="cp_one_father_mobile_no" maxlength="10" value="<?=$cp_one_father_mobile_no; ?>" onpaste="return false">
                                    <span id="cp_one_father_mobile_lbl_error" style="color: red;float: left;"></span>
                                    <?php echo form_error('cp_one_father_mobile_no');?>
                                 </td>
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_mother_mobile_no" id="cp_one_mother_mobile_no" maxlength="10" value="<?=$cp_one_mother_mobile_no; ?>" onpaste="return false">
                              ...
                              <tr>
                                 ...
                                 <td style="text-align: left;">
                                    <?php
                                       $cp_one_father_alive_val='';
                                       if(set_value('cp_one_father_alive'))
                                       {
                                          $cp_one_father_alive_val=set_value('cp_one_father_alive');
                                       }
                                       elseif($incident_edit_details['cp_1_father_alive'])
                                       {
                                          $cp_one_father_alive_val = $incident_edit_details['cp_1_father_alive'];
                                       }
                                    ?>
                                    <label class="radio-inline">
                                    <input type="radio" name="cp_one_father_alive" value="1" <?php echo $cp_one_father_alive_val==1?'checked':''?> >&nbsp;Yes</label>&nbsp;&nbsp;
                                    <label class="radio-inline">
                                       <input type="radio" name="cp_one_father_alive" value="2" <?php echo $cp_one_father_alive_val==2?'checked':''?>>&nbsp;No</label>
                                 ...
                                 <td style="text-align: left;">
                                    <?php
                                       ...
                                       elseif($incident_edit_details['cp_1_mother_alive'])
                                       {
                                          $cp_one_mother_alive_val = $incident_edit_details['cp_1_mother_alive'];
                                       }
                                    ?>

                                    <label class="radio-inline">
                                    <input type="radio" name="cp_one_mother_alive" value="1" <?php echo $cp_one_mother_alive_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                                    <label class="radio-inline">
                                    <input type="radio" name="cp_one_mother_alive" value="2" <?php echo $cp_one_mother_alive_val==2?'checked':''?>>&nbsp;No</label>
            ...
            <div id="menu2" class="tab-pane fade">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     <?php
                        $cp_two_is_available_val='';
                        if(set_value('cp_two_is_available'))
                        {
                           $cp_two_is_available_val=set_value('cp_two_is_available');
                        }
                        elseif($incident_edit_details['cp_two_is_available'])
                        {
                           $cp_two_is_available_val = $incident_edit_details['cp_two_is_available'];
                        }
                     ?>
                     <label class="radio-inline">
                     <input type="radio" name="cp_two_is_available" class="cp_two_is_available_button" value="1" <?php echo $cp_two_is_available_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                     <label class="radio-inline">
                     <input type="radio" name="cp_two_is_available" class="cp_two_is_available_button" value="2" <?php echo $cp_two_is_available_val==2?'checked':''?>>&nbsp;No</label>&nbsp;&nbsp;
               ...
               <div id="cp_two_hide_show_div">
                  <div class="card-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           ...
                           <?php
                              $cp_two_state_val='';
                              if(set_value('cp_two_state'))
                              {
                                 $cp_two_state_val=set_value('cp_two_state');
                              }
                              elseif($incident_edit_details['cp_2_state'])
                              {
                                 $cp_two_state_val = $incident_edit_details['cp_2_state'];
                              }
                           ...
                           <select class="form-control cp_two_state_box" id="cp_two_state" autocomplete="off" name="cp_two_state">
                              ...
                              <?php foreach($state as $value){?>
                              <option value="<?php echo $value['state_id_pk']; ?>" <?php echo set_select('cp_two_state', $value['state_id_pk']); ?> <?= $cp_two_state_val==$value['state_id_pk']?'selected':''?>><?php echo $value['state_name']; ?></option>
                              <?php } ?>
                           </select>
                        </div>
                     </div>
                     ...
                     <div id="cp_two_address_div_two">
                        <div class="form-group row">
                           <label class="col-sm-3 col-form-label">Address <font color="red">*</font></label>
                           <?php
                              $cp_two_address_val= NULL;
                              if(set_value('cp_two_address'))
                              {
                                 $cp_two_address_val=set_value('cp_two_address');
                              }
                              elseif($incident_edit_details['cp_2_address'])
                              {
                                 $cp_two_address_val = $incident_edit_details['cp_2_address'];
                              }
                           ?>
                           <div class="col-sm-6">
                              <textarea class="form-control" name="cp_two_address" id="cp_two_address" rows="3" placeholder="Address"><?= $cp_two_address_val ?></textarea>
                  ...
                  <div class="card-body">
                        ...
                        <div class="col-sm-9">
                           <div class="des-loc">
                              <?php 
                                 ...
                                 {
                                    $cp_two_gender_val=set_value('cp_two_gender');
                                 }
                                 elseif($incident_edit_details['cp_2_gender'])
                                 {
                                    $cp_two_gender_val = $incident_edit_details['cp_2_gender'];
                                 }
                              foreach($gender_details as $value){?>
                              <div class="inp-radio">
                                 <label class="radio-inline"><input type="radio" class="cp_two_gender_val" name="cp_two_gender" value="<?php echo $value['cm_gender_master_id_pk']?>" <?php echo $cp_two_gender_val==$value['cm_gender_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                              </div>
                              <?php } ?>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <div class="des-loc">
                              <?php 
                                 $cp_two_social_category_val='';
                                 if(set_value('cp_two_social_category'))
                                 {
                                    $cp_two_social_category_val=set_value('cp_two_social_category');
                                 }
                                 elseif($incident_edit_details['cp_2_social_category'])
                                 {
                                    $cp_two_social_category_val = $incident_edit_details['cp_2_social_category'];
                                 }
                              foreach($social_category_details as $value){?>
                              <div class="inp-radio">
                                 <label class="radio-inline"><input type="radio" name="cp_two_social_category" value="<?php echo $value['cm_social_category_master_id_pk']?>" <?php echo $cp_two_social_category_val==$value['cm_social_category_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                              </div>
                              <?php } ?>
                           ...
                           <div class="des-loc">
                              <?php 
                                $cp_two_religion_val='';
                                 ...
                                 {
                                    $cp_two_religion_val=set_value('cp_two_religion');
                                 }
                                 elseif($incident_edit_details['cp_2_religion'])
                                 {
                                    $cp_two_religion_val = $incident_edit_details['cp_2_religion'];
                                 } 
                              foreach($religion_details as $value){?>
                              <div class="inp-radio">
                                 <label class="radio-inline"><input type="radio" name="cp_two_religion" value="<?php echo $value['cm_religion_master_id_pk']?>" <?php echo $cp_two_religion_val==$value['cm_religion_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                              </div>
                              <?php } ?>
                  ...
                  <div class="card-body">
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Date of Birth (dd/mm/yyyy) <font color="red">*</font></label>
                        <div class="col-sm-6">
                           <input type="text" class="form-control datepicker_dob" data-date-end-date="0d" id="cp_two_dob" placeholder="Date of Birth" autocomplete="off" name="cp_two_dob" value="<?=$cp_two_dob; ?>" style="background-color: white;" readonly tabindex="7">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           ...
                           <input type="text" class="form-control" name="cp_two_age_months" id="cp_two_age_months" autocomplete="off" placeholder="Age" value="<?php echo set_value('cp_two_age_months'); ?>" maxlength="2" readonly style="cursor: not-allowed;">

                           <input type="hidden" class="form-control js-input-mobile" name="cp_two_age" id="cp_two_age" autocomplete="off" placeholder="Age" value="<?=$cp_two_age; ?>" maxlength="2" readonly style="cursor: not-allowed;">
						   <span id="cp_two_age_error" style="color: red;"></span>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <?php
                             $cp_two_dob_document_available_val='';
                              if(set_value('cp_two_dob_document_available'))
                              {
                                 $cp_two_dob_document_available_val=set_value('cp_two_dob_document_available');
                              }
                              elseif($incident_edit_details['cp_2_dob_document_available'])
                              {
                                 $cp_two_dob_document_available_val = $incident_edit_details['cp_2_dob_document_available'];
                              }  
                           ?>
                           <label class="radio-inline">
                           <input type="radio" name="cp_two_dob_document_available" class="dob_document_cp_two" value="1" <?php echo $cp_two_dob_document_available_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                           <label class="radio-inline">
                           <input type="radio" name="cp_two_dob_document_available" class="dob_document_cp_two" value="2" <?php echo $cp_two_dob_document_available_val==2?'checked':''?>>&nbsp;No</label>&nbsp;&nbsp;
                  ...
                  <div class="card-body" id="dob_document_available_cp_two">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <div class="des-loc">
                              <?php 
                              $cp_two_dob_document_type_val='';
                              if(set_value('cp_two_dob_document_type'))
                              {
                                 $cp_two_dob_document_type_val=set_value('cp_two_dob_document_type');
                              }
                              elseif($incident_edit_details['cp_2_dob_document_type'])
                              {
                                 $cp_two_dob_document_type_val = $incident_edit_details['cp_2_dob_document_type'];
                              }  
                              foreach($document_type_details as $value){?>
                              <div class="inp-radio">
                                 <label class="radio-inline"><input type="radio" name="cp_two_dob_document_type" value="<?php echo $value['cm_document_type_master_master_id_pk']?>" <?php echo $cp_two_dob_document_type_val==$value['cm_document_type_master_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                              </div>
                              <?php } ?>
                  ...
                  <div class="card-body">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <?php
                              $cp_two_identity_document_available_val='';
                              if(set_value('cp_two_identity_document_available'))
                              {
                                 $cp_two_identity_document_available_val=set_value('cp_two_identity_document_available');
                              }
                              elseif($incident_edit_details['cp_2_identity_document_available'])
                              {
                                 $cp_two_identity_document_available_val = $incident_edit_details['cp_2_identity_document_available'];
                              }
                           ?>
                           <label class="radio-inline">
                           <input type="radio" name="cp_two_identity_document_available" class="identity_document_cp_two" value="1" <?php echo $cp_two_identity_document_available_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                           <label class="radio-inline">
                           <input type="radio" name="cp_two_identity_document_available" class="identity_document_cp_two" value="2" <?php echo $cp_two_identity_document_available_val==2?'checked':''?>>&nbsp;No</label>&nbsp;&nbsp;
                        ...
                        <div class="col-sm-9">
                           <div class="des-loc">
                              <?php 
                                 ...
                                 elseif($incident_edit_details['cp_2_identity_document_type'])
                                 {
                                    $cp_two_identity_document_type_val = $incident_edit_details['cp_2_identity_document_type'];
                                 }
                              foreach($document_type_details as $value){?>
                              <div class="inp-radio">
                                 <label class="radio-inline"><input type="radio" name="cp_two_identity_document_type" value="<?php echo $value['cm_document_type_master_master_id_pk']?>" <?php echo $cp_two_identity_document_type_val==$value['cm_document_type_master_master_id_pk']?'checked':''?>>&nbsp;<?php echo $value['description']?></label>&nbsp;&nbsp;
                              </div>
                              <?php } ?>
                        ...
                        <div class="col-sm-9">
                           <div class="des-loc">
                              <?php 
                                 ...
                                 elseif($incident_edit_details['cp_2_highest_educational_attainment'])
                                 {
                                    $cp_two_highest_educational_attainment_val = $incident_edit_details['cp_2_highest_educational_attainment'];
                                 }
                              foreach($highest_education_details as $value){?>
                              <div class="inp-radio">
                                 <label class="radio-inline"><input type="radio" name="cp_two_highest_educational_attainment" value="<?php echo $value['cm_highest_educational_attainment_master_id_pk']?>" <?php echo $cp_two_highest_educational_attainment_val==$value['cm_highest_educational_attainment_master_id_pk']?'checked':''?>>&nbsp;  <?php echo $value['description']?></label>&nbsp;&nbsp;
                              </div>
                              <?php } ?>
                           ...
                           <div class="col-sm-12">
                              <table class="table table-bordered" id="documents_collected_table_field">
                                 ...
                                 <tr>
                                    <td style="text-align: left; font-weight: bold;">Phone No</td>
                                    <td>
                                       <input type="text" class="form-control" name="cp_two_father_mobile_no" id="cp_two_father_mobile_no" maxlength="10" value="<?=$cp_two_father_mobile_no; ?>" onpaste="return false">
                                       <span id="cp_two_father_mobile_lbl_error" style="color: red;float: left;"></span>
                                       <?php echo form_error('cp_two_father_mobile_no');?>
                                    </td>
                                    <td>
                                       <input type="text" class="form-control" name="cp_two_mother_mobile_no" id="cp_two_mother_mobile_no" maxlength="10" value="<?=$cp_two_mother_mobile_no; ?>" onpaste="return false">
                                 ...
                                 <tr>
                                    ...
                                    <td style="text-align: left;">
                                       <?php
                                          ...
                                          elseif($incident_edit_details['cp_2_father_alive'])
                                          {
                                             $cp_two_father_alive_val = $incident_edit_details['cp_2_father_alive'];
                                          }
                                       ?>
                                       <label class="radio-inline">
                                       <input type="radio" name="cp_two_father_alive" value="1" <?php echo $cp_two_father_alive_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                                       <label class="radio-inline">
                                       <input type="radio" name="cp_two_father_alive" value="2" <?php echo $cp_two_father_alive_val==2?'checked':''?>>&nbsp;No</label>
                                    ...
                                    <td style="text-align: left;">
                                       <?php
                                          ...
                                          elseif($incident_edit_details['cp_2_mother_alive'])
                                          {
                                             $cp_two_mother_alive_val = $incident_edit_details['cp_2_mother_alive'];
                                          }
                                       ?>
                                       <label class="radio-inline">
                                       <input type="radio" name="cp_two_mother_alive" value="1" <?php echo $cp_two_mother_alive_val==1?'checked':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
                                       <label class="radio-inline">
                                       <input type="radio" name="cp_two_mother_alive" value="2" <?php echo $cp_two_mother_alive_val==2?'checked':''?>>&nbsp;No</label>
...
swal({
title: "Any information you may have entered will not be saved. Do you want to cancel, or return to the intervention Report",
type: "warning",
showCancelButton: true,
confirmButtonClass: "btn-success",
confirmButtonText: "Return to intervention Report",
...
<script type="text/javascript">
swal({
title: "The Intervention Report has been saved in the Register",
type: "warning",
confirmButtonClass: "btn-success",
...
var url = 'reporting/incident/incident_form/save_as_draft_final_update';
$.ajax({
type : 'POST',
url : url,
data : $('#incident_form_edit').serialize() + "&incident_update_id="+incident_update_id+"&is_save_as_draft_update=YES",
success(response){
...
var url = 'reporting/incident/incident_form/save_incident_details';
$.ajax({
type : 'POST',
url : url,
data : $('#incident_form_edit').serialize() + "&is_save=YES",
success(response){
// console.log(response);
window.location.href = 'reporting/incident/incident_list';
}
...
showCancelButton: true,
confirmButtonClass: "btn-success",
confirmButtonText: "Save as Draft and return to Intervention",
cancelButtonClass: "btn-primary",
cancelButtonText: "Save as draft and close Intervention Report",
closeOnConfirm: false,
closeOnCancel: false/*,
showLoaderOnConfirm: true*/
},
...
var incident_update_id = $('#hid_incident_maxid').val();
if(incident_update_id != ''){
var url = 'reporting/incident/incident_form/save_as_draft_update';
$.ajax({
type : 'POST',
dataType: "json",
url : url,
...
var url = 'reporting/incident/incident_form/save_as_draft';
$.ajax({
type : 'POST',
dataType: "json",
url : url,
data : $('#incident_form_edit').serialize() + "&is_save_as_draft=NO",
success(response){
//alert(response);
if(response.local_persons_involved_array_keys){
$.each(response.local_persons_involved_array_keys, function(index, personId) {
...
//     }
// }
// function updateMarriageDateField() {
//     if ($('input[name="marriage_date"]').is(':checked')) {
//         // If checkbox is checked, disable and clear marriage date input field
//         $('input[name="marriage_date"]').prop('disabled', true);
//         $('input[name="marriage_date"]').val('');
//     }
//     else {
//         // If checkbox is unchecked, enable marriage date input field
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('.marriage_details_check').on('click', function () {
        var selectedValue = $(this).val();

        if(selectedValue=='1'){
          //alert("You selected-- " + selectedValue);
          $('#marriage_date').val(''); // Clear the field
          $("#marriage_date").datepicker("destroy");
          $('#marriage_date').datepicker({
            minDate: null, // This allows all dates, including past, present, and future
            dateFormat: "dd/mm/yy"
          });
          ...
          $("#marriage_date").datepicker("destroy");
          $('#marriage_date').datepicker({
              minDate: null, // Allows past dates
              maxDate: 0, // Restricts future dates
              dateFormat: "dd/mm/yy"
          });
