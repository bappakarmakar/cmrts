   ...
   <section class="content">
      <div class="box bottom-box container">
        <!-- <form action="reporting/incident/incident_form/" id="incident_form" class="incident_form" name="incident_form" method="post"> -->
            ...
            <?php echo form_open_multipart('admin/reporting/incident/incident_form/', array('class' => 'incident_form','name' => 'incident_form', 'id' => 'incident_form')) ?>
         ...
         <div class="tab-content">
            ...
            <div id="home" class="tab-pane fade in active">
               <div class="card-body">
                  <div class="form-group row">
                     <label class="col-sm-12 col-form-label badge badge-Primary text-wrap " style="width: 21rem; font-size:medium;">Prevention Intervention</label>
                  </div>
               </div>
              <div class="card-body">
                <div class="row">
                  ...
                  <label class="col-sm-4 col-form-label">Date of intervention&nbsp;(dd/mm/yyyy) <font color="red">*</font></label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control datepicker_inc_date" data-date-end-date="0d" id="incident_date" placeholder="Intervention Date" readonly autocomplete="off" name="incident_date" value="<?php echo set_value('incident_date'); ?>" style="background-color: white;margin-left: 29px;" tabindex="7">
                  ...
                  <label class="col-sm-4 col-form-label d-flex">Date of marriage&nbsp;(dd/mm/yyyy)<font color="red" id="font-str">*</font></label>
                    <div class="col-sm-8">
                      <div class="d-flex">
                      <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="Marriage Date" readonly autocomplete="off" name="marriage_date" value="<?php echo set_value('marriage_date'); ?>" style="background-color: white;margin-left: 29px;" tabindex="7" >
                  ...
                  <div class="form-group row" style="margin-bottom: 0;">
                    ...
                    <div class="col-sm-3">
                     ...
                     ?>
                        ...
                        <input type="radio" name="prevented_details" id="prevented_details" value="<?php echo $value['cm_incident_report_details_master_id_pk']?>" <?php echo set_radio('prevented_details', $value['cm_incident_report_details_master_id_pk']); ?> style="float: right;margin-right: 0px;"><br>
                        <?php } ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      ...
                      <?php if($this->session->userdata('stake_id_fk') == '4' && $this->session->userdata('subdiv') == '' || $this->session->userdata('stake_id_fk') == '2')
                      { 
                        ?>
                        <select class="form-control" name="incident_block" id="incident_block"  style="cursor: not-allowed;" readonly>
                        ...
                        <select class="form-control" name="incident_block" id="incident_block" readonly>
                           ...
                           <?php //print_r($sdo_deo_level_block_name);die;?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <?php if($this->session->userdata('block') != '' && $this->session->userdata('subdiv') != ''){?>
                            <?php //echo "<pre>"."------------------------------------"; print_r($Incident_Ward);?>
                  ...
                  <div class="left-form">
                     <div class="form-group row">
                       ...
                       <div class="col-sm-5">
                         ...
                         <?php echo form_error('identity_state');?>  
                       </div>
                     </div>
                     <div class="form-group row">
                       <label class="col-sm-3 col-form-label">District <font color="red">*</font></label>
            ...
            <div id="submenu2" class="tab-pane fade">
               <div class="card-body">
                  <div class="form-group row">
                     <label class="col-sm-12 col-form-label badge badge-Primary text-wrap " style="width: 42rem; font-size:medium;">Local Persons Involved in Prevention Intervention</label>
                  </div>
               </div>
               <div class="card-body">
                           ...
                           <div class="col-sm-12">
                              <table class="table table-bordered" id="Officials_Involved_Table_Field">
                                 ...
                                 <tr class="Officials_Involved_Table_Remove" id="delete_officials_involved_row<?php if($this->input->post('Officials_Involved_Details')){ echo $key; ?><?php }else{?><?php echo $key; ?><?php } ?>">
                                    ...
                                    <td><input type="text" id="no" class="form-control" oninput="mobile_no_validation(this)" name="Officials_Involved_Details[<?php echo $key ?>][officials_involved_contact_no]" placeholder="Contact No"  maxlength="10" value="<?php echo $value['officials_involved_contact_no']; ?>" onpaste="return false"></td>
            ...
            <div id="menu1" class="tab-pane fade">
               ...
               <div class="card-body">
                  ...
                  <?php //print_r($CP_One_District_Details); die;?>
               ...
               <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control datepicker_dob" data-date-end-date="0d" id="cp_one_dob" placeholder="Date of Birth" autocomplete="off" name="cp_one_dob" value="<?php echo set_value('cp_one_dob'); ?>" style="background-color: white;" readonly tabindex="7">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control" name="cp_one_age_months" id="cp_one_age_months" autocomplete="off" placeholder="Age" value="<?php echo set_value('cp_one_age_months'); ?>" maxlength="2" readonly style="cursor: not-allowed;">
                      ...
                      <input type="hidden" class="form-control js-input-mobile" name="cp_one_age" id="cp_one_age" autocomplete="off" placeholder="Age" value="<?php echo set_value('cp_one_age'); ?>" maxlength="2" readonly style="cursor: not-allowed;">
                        ...
                        <div class="col-sm-12">
                           <table class="table table-bordered" id="documents_collected_table_field">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_father_mobile_no" id="cp_one_father_mobile_no" maxlength="10" value="<?php echo set_value('cp_one_father_mobile_no'); ?>" onpaste="return false">
                                    <span id="cp_one_father_mobile_lbl_error" style="color: red;float: left;"></span> 
                                    <?php echo form_error('cp_one_father_mobile_no');?> 
                                 </td>
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_mother_mobile_no" id="cp_one_mother_mobile_no"  maxlength="10" value="<?php echo set_value('cp_one_mother_mobile_no'); ?>" onpaste="return false">
                ...
                <div id="cp_two_hide_show_div">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <?php echo form_error('cp_two_state');?> 
                        </div>
                      </div>
                   ...
                   <div class="card-body">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Date of Birth (dd/mm/yyyy) <font color="red">*</font></label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control datepicker_dob" data-date-end-date="0d" id="cp_two_dob" placeholder="Date of Birth" autocomplete="off" name="cp_two_dob" value="<?php echo set_value('cp_two_dob'); ?>" style="background-color: white;" readonly tabindex="7">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="hidden" class="form-control js-input-mobile" name="cp_two_age" id="cp_two_age" autocomplete="off" placeholder="Age" value="<?php echo set_value('cp_two_age'); ?>" maxlength="2" readonly style="cursor: not-allowed;">
                            ...
                            <div class="col-sm-12">
                               <table class="table table-bordered" id="documents_collected_table_field">
                                  ...
                                  <tr>
                                     <td style="text-align: left; font-weight: bold;">Phone No</td>
                                     <td>
                                        <input type="text" class="form-control" name="cp_two_father_mobile_no" id="cp_two_father_mobile_no" maxlength="10" value="<?php echo set_value('cp_two_father_mobile_no'); ?>" onpaste="return false">
                                        <span id="cp_two_father_mobile_lbl_error" style="color: red;float: left;"></span>
                                        <?php echo form_error('cp_two_father_mobile_no');?>
                                     </td>
                                     <td>
                                        <input type="text" class="form-control" name="cp_two_mother_mobile_no" id="cp_two_mother_mobile_no" maxlength="10" value="<?php echo set_value('cp_two_mother_mobile_no'); ?>" onpaste="return false">
...
<script type="text/javascript">
 ...
 function(isConfirm){
   if(isConfirm){
      // var incident_update_id = $('#hid_incident_maxid').valsave_as_draft_update();
      var incident_update_id = $('#hid_incident_maxid').val();
      if(incident_update_id != ''){
         // var url = 'reporting/incident/incident_form/';
        ...
        // var test = $('#incident_form').serialize() + "&incident_update_id="+incident_update_id+"&is_save_as_draft_update=YES",
        // var test = $('#incident_form').serialize() + "&is_save_as_draft=NO";
        // alert(test);
   ...
   $(document).ready(function() {
    ...
    function hide_trash_button(marriage_date)
    {
     ...
     // alert(test);
      ...
      // if(typeof(marriage_date) != "undefined" && marriage_date !== null)
      //   {
      //     $('#trash').prop('disabled', true);
      //   }
      //   else
...
<!-- <script>
  $(document).ready(function () {
    ...
    $('#incident_date').change(function () {

      const home_enqry_date = $(this).val(); // Get the selected home_enqry_date in dd/mm/yyyy format
      const bate_of_birth = $('#cp_one_dob').val(); // Get the selected dob in dd/mm/yyyy format
    ...
    if (home_enqry_date && bate_of_birth) { // Fix condition to check both inputs
        ...
        $('#cp_one_age_months').val(`${years} years ${months} months ${days} days`);
    } else {
...
<!-- <script>
  $(document).ready(function () {
    ...
    $('#incident_date').change(function () {
      ...
      const home_enqry_date = $(this).val(); // Get the selected home_enqry_date in dd/mm/yyyy format
      const bate_of_birth = $('#cp_two_dob').val(); // Get the selected dob in dd/mm/yyyy format
    ...
    if (home_enqry_date && bate_of_birth) { // Fix condition to check both inputs
        ...
        // Display the result in HTML
        $('#cp_two_age_months').val(`${years} years ${months} months ${days} days`);
    } else {
...
<!-- <script>
  $(document).ready(function () {
    $('#cp_one_dob').change(function () {
      const dob = $(this).val(); // Get the selected DOB in dd/mm/yyyy format
      if (dob) {
        // Parse the DOB input
        const [day, month, year] = dob.split('/').map(Number); // Extract day, month, year
        const dobDate = new Date(year, month - 1, day); // Create a Date object for DOB
        const today = new Date(); // Get today's date

        // Calculate the difference
        const ageYears = today.getFullYear() - dobDate.getFullYear();
        const ageMonths = today.getMonth() - dobDate.getMonth();
        const ageDays = today.getDate() - dobDate.getDate();

        // Correct for negative months or days
        let finalYears = ageYears;
        let finalMonths = ageMonths;
        let finalDays = ageDays;
        ...
        // Display the result
        const ageText = `${finalYears} Years, ${finalMonths} Months, ${finalDays} Days`;
        $('#cp_one_age_months').val(ageText); // Update the age field
        //$('#cp_one_age_error').text(''); // Clear any error messages
      } else {
        // Handle empty or invalid DOB
        $('#cp_one_age_months').val('');
        //$('#cp_one_age_error').text('Please select a valid Date of Birth.');
      }
    });
  });
</script> -->
  ...
  $(document).ready(function () {
    $('#cp_two_dob').change(function () {
      ...
      if (dob) {
        ...
        // Display the result
        const ageText = `${finalYears} Years, ${finalMonths} Months, ${finalDays} Days`;
        $('#cp_two_age_months').val(ageText); // Update the age field
        //$('#cp_two_age_error').text(''); // Clear any error messages
      } else {
        // Handle empty or invalid DOB
        $('#cp_two_age_months').val('');
        //$('#cp_two_age_error').text('Please select a valid Date of Birth.');
      }
    });
  });
</script> -->
...
<script>
    $(document).ready(function () {
        ...
        $('input[name="cp_two_is_available"]').on('change', function () {
          var cp_two_is_available = $(this).val();
          ...
          if(cp_two_is_available=='2'){
            ...
            $('#cp_two_m_name').val('');
            $('#cp_two_l_name').val('');
            $('#cp_two_street_landmark').val('');

            var cp_two_state_value = $('#cp_two_state').val();
            if(cp_two_state_value=='1'){
              $('#cp_two_district').val('0');
              $('#cp_two_block').val('0');
              $('#cp_two_ward_gp').val('0');
            }
            else if(cp_two_state_value=='2'){
              $('#cp_two_address').val('');
            }
            $('#cp_two_state').val('0');

            $('#cp_two_pin_code').val('');
            $('#cp_two_police_station').val('');
            $('#cp_two_phone_no').val('');
            $('input[name="cp_two_gender"]').prop('checked', false);
            $('input[name="cp_two_social_category"]').prop('checked', false);
            $('input[name="cp_two_religion"]').prop('checked', false);
            $('#cp_two_dob').val('');
            $('#cp_two_age').val('');

            const dob_doc_type = $('input[name="cp_two_dob_document_available"]:checked').val();
            if(dob_doc_type=='1'){
              $('#cp_two_dob_document_id').val('');
              $('input[name="cp_two_dob_document_type"]').prop('checked', false);
            }
            $('input[name="cp_two_dob_document_available"]').prop('checked', false);

            const identity_doc_type = $('input[name="cp_two_identity_document_available"]:checked').val();
            if(identity_doc_type=='1'){
              $('#cp_two_identity_document_id').val('');
              $('input[name="cp_two_identity_document_type"]').prop('checked', false);
            }
            $('input[name="cp_two_identity_document_available"]').prop('checked', false);
            $('input[name="cp_two_highest_educational_attainment"]').prop('checked', false);
            $('#cp_two_father_name').val('');
            $('#cp_two_mother_name').val('');
            $('#cp_two_father_mobile_no').val('');
            $('#cp_two_mother_mobile_no').val('');
            $('input[name="cp_two_father_id"]').val('');
            $('input[name="cp_two_mother_id"]').val('');
            $('select[name="cp_two_father_id_type"]').val('0');
            $('select[name="cp_two_mother_id_type"]').val('0');

            $('input[name="cp_two_father_alive"]').prop('checked', false);
            $('input[name="cp_two_mother_alive"]').prop('checked', false);
