...
<div class="content-wrapper">
   <section class="content-header">
      <h1>Intervention Report Edit</h1>
      <ol class="breadcrumb">
               ...
               <div class="card-body">
                     ...
                     <div class="col-md-8">
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8">
                              <?php
                              $incident_date='';
                              if(set_value('incident_date'))
                              {
                                 $incident_date=set_value('incident_date');
                              }
                              elseif($incident_edit_details['incident_date'])
                              {
                                 $incident_date = date('d/m/Y',strtotime($incident_edit_details['incident_date']));
                              }
                              ?>
                              <input type="text" class="form-control datepicker_inc_date" data-date-end-date="0d" id="incident_date" placeholder="Intervention Date" readonly autocomplete="off" name="incident_date" value="<?=$incident_date; ?>" style="background-color: white;margin-left: 29px;" tabindex="7">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8">
                              <div class="d-flex">
                                 <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="marriage date" readonly autocomplete="off" name="marriage_date" value="<?=$marriage_date; ?>" style="background-color: white; margin-left: 29px;" tabindex="7">
                     ...
                     <div class="col-md-3">
                        <fieldset class="scheduler-border">
                           ...
                           <div class="right_marriage_details" style="text-align: right;">
                              ...
                              <input type="radio" name="marriage_details" id="marriage_details" class="marriage_details_check" value="<?php echo $value['cm_marriage_master_id_pk']?>" <?php echo $marriage_details_val==$value['cm_marriage_master_id_pk']?'checked':'';?> style="float: right;margin-right: 0px;">&nbsp;<br>
                              <?php } ?>
                     ...
                     <div class="col-sm-3" style="text-align: right;">
                        <fieldset class="scheduler-border">
                           ...
                           <div class="prevented_details">
                              ...
                              <input type="radio" name="prevented_details" id="prevented_details" value="<?php echo $value['cm_incident_report_details_master_id_pk']?>" <?php echo $prevented_details_val== $value['cm_incident_report_details_master_id_pk']?'checked':'' ?> style="float: right;margin-right: 0px;"><br>
                              <?php } ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        ...
                        <!-- <?php //echo "<pre>";print_r($block_details_name); ?> -->
                        <!-- <select class="form-control" name="incident_block" id="incident_block" readonly style="cursor: not-allowed;"> -->
                        ...
                        <?php echo form_error('police_station');?>
                           ...
                           foreach($location_description_details as $value){?>
                                                    <div class="inp-radio">
                              <label class="radio-inline"><input type="radio" name="location_description" id="location_description" value="<?php echo $value['cm_location_master_id_pk']?>" 
                                 <?php echo $location_description_val== $value['cm_location_master_id_pk']?'checked':'' ?>
                           ...
                           <?php echo form_error('cp_two_identity_document_id');?>
                              ...
                              <?php echo form_error('cp_two_highest_educational_attainment');?>
                                    ...
                                    <td style="text-align: left; font-weight: bold;">Phone No</td>
                                       ...
                                       <td style="text-align: left;">
                                       <label class="radio-inline">
                                          <input type="radio" name="cp_two_father_alive" value="1" <?php echo set_radio('cp_two_father_alive', '1'); ?> <?=($incident_edit_details)?($incident_edit_details['cp_2_father_alive']==1)?'checked':'':''?>>&nbsp;Yes</label>&nbsp;&nbsp;
