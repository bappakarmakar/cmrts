...
?>
<?php echo form_open('admin/reporting/incident/incident_list/follow_up_visit_form/'.$record_num_1.'/'.$record_num_2.'/'.$record_num_3, array('class' => 'follow_up_visit_form','name' => 'follow_up_visit_form', 'id' => 'follow_up_visit_form'))?>
                  ...
                  <div class="col-md-9">
                     ...
                     <div class="name-add-section" style="width: 60%;padding-top: 40px;">
                        ...
                        <div class="form-group" style="margin-top: 20px;width: 50%;">
                           ...
                           <input type="hidden" class="form-control " name="age_on_folllowup" id="age_on_folllowup" autocomplete="off" placeholder="Age" value="" maxlength="2" readonly style="cursor: not-allowed;">
