...
@media print {
   ...
   select {
  position: relative;
  width: fit-content; /* Set width as needed */
  appearance: none;
...
/* Add a pseudo-element for the custom dropdown arrow */
select::after {
  content: '';
  position: absolute;
  top: calc(50% - 2px); /* Adjust vertical position as needed */
  right: 8px; /* Adjust horizontal position as needed */
  width: 0;
  height: 0;
  border-left: 4px solid transparent;
  border-right: 4px solid transparent;
  border-top: 4px solid #555; /* Set arrow color */
  pointer-events: none;
  z-index: 2;
}
                 ...
                 <div class="card-body p-0">
                             ...
                             <div id="step-one" class="content" role="tabpanel" aria-labelledby="step-one-trigger">
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-lg-3 col-md-2 col-sm-4 col-xs-3">
                                         <?php
                                            ...
                                            ?>
                                         <span style="<?php echo $marriage_details_css; ?>"><?php echo $value['description']?></span><input type="radio" value="<?php echo $value['cm_marriage_master_id_pk']?>" name="marriage_details" <?=($incident_edit_details)?($incident_edit_details['marriage_details']==$value['cm_marriage_master_id_pk'])?'checked':'':''?> class="mar-det" style="float: right;"><br>
                                         <?php } ?>
                                      </div>
                                   </div>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-xs-5 col-xs-5">
                                       <input type="text" class="form-control " value="<?=$ward_gp_name?>">
                                       </div>
                                      <!-- <div class="col-sm-5"> -->
                                     ...
                                     <?php if($incident_edit_details['cp_1_state']!=1){ ?>
                                        <div id="cp_1_address_div_two">
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                              <textarea class="form-control" name="cp_two_address" id="cp_1_address" rows="3" placeholder="Address"><?=($incident_edit_details)?$incident_edit_details['cp_1_address']:set_value('cp_1_address'); ?></textarea>
                   ...
                   <div class="card-body">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Date of Birth (dd/mm/yyyy) <font color="red">*</font></label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control datepicker" data-date-end-date="0d" id="cp_two_dob" placeholder="Date of Birth" autocomplete="off" name="cp_two_dob" 
                           value="<?php echo !empty($incident_edit_details['cp_2_dob']) ? date('d-m-Y', strtotime($incident_edit_details['cp_2_dob'])) : ''; ?>"

                           style="background-color: white;" readonly tabindex="7">
