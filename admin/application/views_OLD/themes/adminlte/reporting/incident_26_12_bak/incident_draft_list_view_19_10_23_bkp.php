...
<div class="content-wrapper">
   <section class="content-header">
      <h1>Incident Report Draft List</h1>
      <ol class="breadcrumb">
            ...
            <table class="table table-bordered table-hover" id="mytable">
               ...
               <tbody id="childAppend">
                  ...
                  <tr>
                     ...
                     <td><?php echo $value->cp_one_gender; ?></td>
                     <td><?php echo $value->cp_one_age; ?></td>
                     <td><?php echo $value->cp_one_ward_gp; ?></td>
                     <td><?php echo $value->cp_two_name; ?></td>
                     <td><?php echo $value->cp_two_gender; ?></td>
                     <td><?php echo $value->cp_two_age; ?></td>
                     <td><?php echo $value->cp_two_ward_gp; ?></td>
                     <td><?php if($value->incident_draft_status == '1'){?><p style="color: red;">Draft Pending</p><?php }else{?><p style="color: green;">Draft Completed</p><?php } ?></td>
                     <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu action_menu" role="menu" aria-labelledby="menu1" style="margin-left: -83px;">
                            ...
                            <?php if($value->incident_draft_status == '1'){?>
