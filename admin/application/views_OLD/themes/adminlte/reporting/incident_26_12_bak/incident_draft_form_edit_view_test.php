<!-- <?php// echo $validation_error_count;die;?> -->
...
?>
   ...
   <section class="content">
      <div class="box bottom-box container">
         ...
         <?php echo form_open('admin/reporting/incident/incident_draft_form/'.base64_encode($incident_id), array('class' => 'incident_form_edit','name' => 'incident_form_edit', 'id' => 'incident_form_edit')) ?>
            ...
            <div id="home" class="tab-pane fade in active">
               <div class="form-btn">
                  <ul>
                     ...
                     <button class="control-btn"><a data-toggle="tab" id="first_next_step" href="#" class="btn btn-success next_step"><i class="fa fa-save" aria-hidden="true"></i> Save </a></button>
                  </ul>
               </div>
               <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group row">
                     <label class="col-sm-3 col-form-label">Date of marriage&nbsp;(dd/mm/yyyy)</label>
                       <div class="col-sm-3">
                            <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="Incident Date" readonly autocomplete="off" name="marriage_date" value="<?=$marriage_date; ?>" style="background-color: white;" tabindex="7">
            ...
            <div id="submenu1" class="tab-pane fade">
                <div class="form-btn">
                  <ul>
                     ...
                     <button class="control-btn"><a data-toggle="tab" id="first_next_step" href="#submenu1" class="btn btn-success next_step"><i class="fa fa-save" aria-hidden="true"></i> Save </a></button>
                  </ul>
               </div> 
               <div class="card-body">
                  <div class="form-group row">
