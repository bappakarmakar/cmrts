   ...
   <section class="content">
      ...
      <div class="box bottom-box">
        <div id="date_div" style="display:none"> 
         ...
         <a href="<?php echo base_url()?>admin/reporting/incident/incident_form" class="btn btn-primary" style="margin-top: 8px; float: right; margin-right: 10px;margin-bottom: 12px;"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Incident</a>
         <?php } ?>
            ...
            <table class="table table-bordered table-hover" id="mytable">
               ...
               <tbody id="childAppend">
                  ...
                  <tr>
                     ...
                     <?php } ?>
                     <td></td>
                     <td><?php echo Get_CP_Current_Status($value->current_status); ?></td>
                     <td>
                        <div class="dropdown" style="">
                            ...
                            <ul class="dropdown-menu action_menu" role="menu" aria-labelledby="menu1" style="margin-left: -83px;">
                              ...
                              <?php if($value->current_status == 2 && $value->delete_status == 0){?>
                              ...
                              <?php if($value->current_status == 3){
                                  ...
                                  if($value->cp_1_age < 18 || $value->cp_2_age < 18){?>
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/home_visit_minor_form/<?php echo base64_encode($value->incident_id_pk); ?>"><i class="fa fa-home" aria-hidden="true"></i>Home Visit Minor</a></li>
                              <?php } ?>

                               <?php if($value->cp_1_age >= 18 || $value->cp_2_age >= 18){?>
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/home_visit_adult_form/<?php echo base64_encode($value->incident_id_pk); ?>"><i class="fa fa-home" aria-hidden="true"></i>Home Visit Adult</a></li>
                              <?php } ?>
                              <?php if($value->cp_1_age < 18 || $value->cp_2_age < 18){?>
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/follow_up_visit_form/<?php echo base64_encode($value->incident_id_pk); ?>"><i class="fa fa-arrow-up" aria-hidden="true"></i>Follow-Up Visit</a></li>
                            <?php } ?>
                            <?php } ?>
                            ...
                            <?php if($value->current_status == 3){
                              if($value->cp_1_age < 18 || $value->cp_2_age < 18){?>
                                ...
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/home_visit_minor_form/<?php echo base64_encode($value->incident_id_pk); ?>/1"><i class="fa fa-home" aria-hidden="true"></i>CP 1 Home Visit Minor</a></li>

                               <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/home_visit_minor_form/<?php echo base64_encode($value->incident_id_pk); ?>/2"><i class="fa fa-home" aria-hidden="true"></i>CP 2 Home Visit Minor</a></li>

                            <?php } } ?>
                              


                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/follow_up_visit_form/<?php echo base64_encode($value->incident_id_pk); ?>/1"><i class="fa fa-arrow-up" aria-hidden="true"></i>CP 1 Follow-Up Visit</a></li>

                               <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()?>admin/reporting/incident/incident_list/follow_up_visit_form/<?php echo base64_encode($value->incident_id_pk); ?>/2"><i class="fa fa-arrow-up" aria-hidden="true"></i>CP 2 Follow-Up Visit</a></li>
      ...
      <div class="modal-dialog modal-lg">
         ...
         <div class="modal-content" id="mod">
            <div class="modal-header custom-modal-header">
               ...
               <h4 class="modal-title text-center">CMRTS Incident Report Data</h4>
            </div>
                    ...
                    <div class="col-md-12">
                       <div class="card card-default">
                          <div class="card-body p-0">
                            ...
                            <div class="card-body">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Incident Date&nbsp;(dd/mm/yyyy)</label>
                                <div class="col-sm-3">
                          ...
                          <div class="card-body">
                             <div class="form-group row">
                               <label class="col-sm-3 col-form-label">Date of Birth (dd/mm/yyyy)</label>
                               <div class="col-sm-6">
                                  <input type="text" class="form-control" value="<?php echo date('d/m/Y', strtotime($value->cp_2_dob)); ?>" disabled>  
                               </div>
                             </div>
                             <div class="form-group row">
                               <label class="col-sm-3 col-form-label">Age</label>
