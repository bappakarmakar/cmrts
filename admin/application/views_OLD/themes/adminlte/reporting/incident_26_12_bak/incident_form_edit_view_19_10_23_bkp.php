...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="box bottom-box container">
         <?php echo form_open('admin/reporting/incident/incident_form/update_incident/'.base64_encode($incident_edit_details[0]['incident_id_pk']), array('class' => 'incident_form_edit','name' => 'incident_form_edit', 'id' => 'incident_form_edit')) ?>
            ...
            <div id="home" class="tab-pane fade in active">
               ...
               <div class="card-body">
                     ...
                     <div class="col-sm-5">
                        <?php
                           ...
                           foreach($marriage_details as $key => $value){
                              if($key == 0){
                                 $marriage_details_css = 'margin-left: 184px';
                              }elseif($key == 1){
                                 $marriage_details_css = 'margin-left: 165px';
                              }else{
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        <select class="form-control district" name="incident_district" id="incident_district" readonly style="cursor: not-allowed;">
                           <option value="<?php echo $incident_edit_details[0]['incident_district_id']; ?>" <?php echo set_select('incident_district', $incident_edit_details[0]['incident_district_id'], False); ?>><?php echo $incident_edit_details[0]['incident_district']; ?></option>
                        </select>
                            ...
                            <?php if(!empty($Incident_Ward_Gp_Block)){?>
                               <?php if($Incident_Ward_Gp_Block->rural_urban == 'U'){?>
                                 <?php foreach($Incident_Ward as $Incident_Ward_Value){ ?>
                                   <option value="<?php echo $Incident_Ward_Value['ward_id_pk'];?>" <?php if($incident_edit_details[0]['ward_gp'] == $Incident_Ward_Value['ward_id_pk']){ echo "selected"; } ?>><?php echo $Incident_Ward_Value['ward_no'];?></option> 
                                 <?php } ?>
                               <?php }else{?>
                                 <?php foreach($Incident_Gp as $Incident_GP_Value){ ?>
                                    <option value="<?php echo $Incident_GP_Value['gp_id_pk'];?>" <?php if($incident_edit_details[0]['ward_gp'] == $Incident_GP_Value['gp_id_pk']){ echo "selected"; } ?>><?php echo $Incident_GP_Value['gp_name'];?></option> 
                                 <?php } ?>
                            <?php } } ?>
                        </select>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        <input type="text" id="pin_code" name="pin_code" class="form-control pin_code_validate" value="<?php if(set_value('pin_code') != ''){?><?php echo set_value('pin_code'); ?><?php }else{?><?php echo $incident_edit_details[0]['pin_code']?><?php } ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
            ...
            <div id="submenu1" class="tab-pane fade">
               <div class="form-btn">
                  <ul>
                     ...
                     <!-- <button><a data-toggle="tab" id="first_prev_step" href="#home" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a></button>

                     <button><a data-toggle="tab" id="second_next_step" href="#submenu2" class="btn btn-primary"> Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a></button> -->
                  </ul>
               </div>
               <div class="card-body">
                  <div class="form-group row">
                     <label class="col-sm-12 col-form-label badge badge-Primary text-wrap " style="width: 41rem; font-size:medium;">Information First Received at SD/Block office from</label>
                  </div>
               </div>
               <div class="card-body">
                  <div class="form-group row">
               ...
               <div class="card-body" id="Anonymous_2">
                  <div class="left-form">
                        ...
                        <div class="col-sm-5">
                           <select class="form-control" id="identity_ward_gp" autocomplete="off" name="identity_ward_gp">
                                ...
                                <?php if(!empty($Identity_Ward_Gp_Block)){?>
                                   ...
                                   <option value="<?php echo $Identity_Ward_Value['ward_id_pk'];?>" <?php if($incident_edit_details[0]['identity_ward_gp'] == $Identity_Ward_Value['ward_id_pk']){ echo "selected"; } ?>><?php echo $Identity_Ward_Value['ward_no'];?></option> 
                                   <?php } ?>
                                 <?php }else{?>
                                   <?php foreach($Identity_Gp as $Identity_GP_Value){ ?>
                                   <option value="<?php echo $Identity_GP_Value['gp_id_pk'];?>" <?php if($incident_edit_details[0]['identity_ward_gp'] == $Identity_GP_Value['gp_id_pk']){ echo "selected"; } ?>><?php echo $Identity_GP_Value['gp_name'];?></option> 
                                   <?php } ?>
                                 <?php } } ?>
                            </select>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                           <input type="text" id="identity_phone_no" name="identity_phone_no" class="form-control identity_phone_no_validate no" value="<?php if(set_value('identity_phone_no') != ''){?><?php echo set_value('identity_phone_no'); ?><?php }else{?><?php echo $incident_edit_details[0]['identity_phone_no']?><?php } ?>" placeholder="Phone No" maxlength="10" onkeyup="phone_number_validation()" onpaste="return false">
            ...
            <div id="submenu2" class="tab-pane fade">
               <div class="form-btn">
                  <ul>
                     ...
                     <!-- <button><a data-toggle="tab" id="second_prev_step" href="#submenu1" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a></button>

                     <button><a data-toggle="tab" id="third_next_step" href="#submenu3" class="btn btn-primary"> Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a></button> -->
                  </ul>
               </div>
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-12">
                        <table class="table table-bordered" id="Local_Persons_Involved_Table_Field">
                           ...
                           <tr id="delete_local_person_row<?php if($this->input->post('Local_Persons_Involved_Details')){ echo $count++; ?><?php }else{?><?php echo $value->sl_no; ?><?php } ?>">
                              <td><input type="text" class="form-control" id="local_person_name" name="Local_Persons_Involved_Details[<?php echo $key ?>][local_person_name]" value="<?php echo $value->local_person_name; ?>" placeholder="Name, if available" onkeypress="return Local_Person_Name_Validate(event);">
                                 <span class="lbl_error_local_person_name" style="color: red;float: left;"></span>
                              </td>
            ...
            <div id="submenu3" class="tab-pane fade">
               <div class="form-btn">
                  <ul>
                     ...
                     <!-- <button><a data-toggle="tab" id="third_prev_step" href="#submenu2" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a></button>

                     <button><a data-toggle="tab" id="fourth_next_step" href="#menu1" class="btn btn-primary"> Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a></button> -->
                  </ul>
               </div>
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-12">
                        <table class="table table-bordered" id="Officials_Involved_Table_Field">
                           ...
                           <tr id="delete_officials_involved_row<?php if($this->input->post('Officials_Involved_Details')){ echo $count++; ?><?php }else{?><?php echo $value->sl_no; ?><?php } ?>">
                              ...
                              <td><input type="text" class="form-control" id="official_involved_name" name="Officials_Involved_Details[<?php echo $key ?>][official_involved_name]" placeholder="Name" value="<?php echo $value->official_involved_name; ?>" onkeypress="return Official_Involved_Name_Validate(event);"><span class="lbl_error_official_involved_name" style="color: red;float: left;"></span></td>
                              ...
                              <td><input type="text" class="form-control officials_involved_contact_no_validate" name="Officials_Involved_Details[<?php echo $key ?>][officials_involved_contact_no]" placeholder="Contact No" maxlength="10" value="<?php echo $value->officials_involved_contact_no; ?>"></td>
                              <td>
                                 <?php if(isset($value->sl_no)){ ?> 
            ...
            <div id="menu1" class="tab-pane fade">
               <div class="form-btn">
                  <ul>
                     ...
                     <!-- <button><a data-toggle="tab" id="fourth_prev_step" href="#submenu3" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a></button>

                     <button><a data-toggle="tab" id="fifth_next_step" href="#menu2" class="btn btn-primary"> Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a></button> -->
                  </ul>
               </div>
               <div class="card-body">
                  <div class="form-group row">
               ...
               <div class="card-body">
                  ...
                  <div class="form-group row">
                     <label class="col-sm-3 col-form-label">Pin Code <font color="red">*</font></label>
                     <div class="col-sm-6">
                        <input type="text" id="cp_one_pin_code" name="cp_one_pin_code" class="form-control cp_one_pin_code_validate" value="<?php if(set_value('cp_one_pin_code') != ''){?><?php echo set_value('cp_one_pin_code'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_one_pin_code']?><?php } ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
                  ...
                  <div class="form-group row">
                     <label class="col-sm-3 col-form-label">Phone No <font color="red">*</font></label>
                     <div class="col-sm-6">
                        <input type="text" id="cp_one_phone_no" name="cp_one_phone_no" class="form-control cp_one_phone_no_validate" value="<?php if(set_value('cp_one_phone_no') != ''){?><?php echo set_value('cp_one_phone_no'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_one_phone_no']?><?php } ?>" placeholder="Phone No" maxlength="10" onpaste="return false">
               ...
               <div class="card-body">
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                       <input type="text" class="form-control" placeholder="Age of Female" name="cp_one_age" id="cp_one_age" placeholder="Age" autocomplete="off" value="<?php if(set_value('cp_one_age') != ''){?><?php echo set_value('cp_one_age'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_one_age']?><?php } ?>" readonly style="cursor: not-allowed;">
               ...
               <div class="card-body" id="dob_document_available_cp_one">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="Document ID" name="cp_one_dob_document_id" id="cp_one_dob_document_id" autocomplete="off" value="<?php echo set_value('cp_one_dob_document_id'); ?><?php echo $incident_edit_details[0]['cp_one_dob_document_id']; ?>">
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <label class="radio-inline"><input type="radio" name="cp_one_identity_document_available" class="identity_document_cp_one" value="1" <?php if(isset($_POST['cp_one_identity_document_available'])){?><?php echo set_radio('cp_one_identity_document_available', '1'); ?><?php }else{?><?php echo ($incident_edit_details[0]['cp_one_identity_document_available']== '1') ?  "checked" : "" ;  ?><?php } ?>>&nbsp;Yes</label>&nbsp;&nbsp;

                        <label class="radio-inline"><input type="radio" name="cp_one_identity_document_available" class="identity_document_cp_one" value="2" <?php if(isset($_POST['cp_one_identity_document_available'])){?><?php echo set_radio('cp_one_identity_document_available', '2'); ?><?php }else{?><?php echo ($incident_edit_details[0]['cp_one_identity_document_available']== '2') ?  "checked" : "" ;  ?><?php } ?>>&nbsp;No</label>&nbsp;&nbsp;
                     ...
                     <div class="col-sm-12">
                        <table class="table table-bordered" id="documents_collected_table_field">
                           ...
                           <tr>
                              ...
                              <td>
                                 <input type="text" class="form-control" id="cp_one_father_name" name="cp_one_father_name" value="<?php if(set_value('cp_one_father_name') != ''){?><?php echo set_value('cp_one_father_name'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_one_father_name']?><?php } ?>" onkeypress="return CP_One_Father_Name_Validate(event);">
                                 <span id="cp_one_father_name_lbl_error" style="color: red;float: left;"></span> 
                                 <?php echo form_error('cp_one_father_name');?> 
                              </td>
                              <td>
                                 <input type="text" class="form-control" id="cp_one_mother_name" name="cp_one_mother_name" value="<?php if(set_value('cp_one_mother_name') != ''){?><?php echo set_value('cp_one_mother_name'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_one_mother_name']?><?php } ?>" onkeypress="return CP_One_Mother_Name_Validate(event);">
            ...
            <div id="menu2" class="tab-pane fade">
               <div class="form-btn">
                  <ul>
                     ...
                     <li>
                        <button type="submit" name="update_incident" class="btn btn-success"><i class="fa fa-paper-plane" aria-hidden="true"></i> Update</button>
                     </li>
                     <!-- <button><a data-toggle="tab" id="fifth_prev_step" href="#menu1" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a></button> -->
                  </ul>
               </div>
               <div class="card-body">
                  <div class="form-group row">
                     <div class="col-sm-12">
                        <label class="badge badge-primary text-wrap" style="width: 21rem; font-size:medium;">Contracting Party Two</label>  
                     </div>
                  </div>
               </div>
               <div class="form-group row">
               ...
               <div id="cp_two_hide_show_div">
                  <div class="card-body">
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Name <font color="red">*</font></label>
                        <div class="col-sm-3">
                           <input type="text" class="form-control" placeholder="First Name" id="cp_two_f_name" name="cp_two_f_name" autocomplete="off" value="<?php if(set_value('cp_two_f_name') != ''){?><?php echo set_value('cp_two_f_name'); ?><?php }elseif($incident_edit_details[0]['cp_two_name']!=''){?><?php echo $cp_two_f_name; ?><?php } ?>" onkeypress="return CP_Two_First_Name_Validate(event);">
                           <span id="cp_two_first_name_lbl_error" style="color: red"></span>
                           <?php echo form_error('cp_two_f_name');?>  
                        </div>
                        <div class="col-sm-3">
                           <input type="text" class="form-control" placeholder="Middle Name" id="cp_two_m_name" name="cp_two_m_name" autocomplete="off" value="<?php if(set_value('cp_two_m_name') != ''){?><?php echo set_value('cp_two_m_name'); ?><?php }elseif($incident_edit_details[0]['cp_two_name']!=''){?><?php echo $cp_two_m_name; ?><?php } ?>" onkeypress="return CP_Two_Middle_Name_Validate(event);">  
                           <span id="cp_two_middle_name_lbl_error" style="color: red"></span>
                        </div>
                        <div class="col-sm-3">
                           <input type="text" class="form-control" placeholder="Last Name" id="cp_two_l_name" name="cp_two_l_name" autocomplete="off" value="<?php if(set_value('cp_two_l_name') != ''){?><?php echo set_value('cp_two_l_name'); ?><?php }elseif($incident_edit_details[0]['cp_two_name']!=''){?><?php echo $cp_two_l_name; ?><?php } ?>" onkeypress="return CP_Two_Last_Name_Validate(event);"> 
                     ...
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Pin Code <font color="red">*</font></label>
                        <div class="col-sm-6">
                           <input type="text" id="cp_two_pin_code" name="cp_two_pin_code" class="form-control cp_two_pin_code_vaidate" value="<?php if(set_value('cp_two_pin_code') != ''){?><?php echo set_value('cp_two_pin_code'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_two_pin_code']?><?php } ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
                     ...
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Phone No <font color="red">*</font></label>
                        <div class="col-sm-6">
                           <input type="text" id="cp_two_phone_no" name="cp_two_phone_no" class="form-control cp_two_phone_no_vaidate" value="<?php if(set_value('cp_two_phone_no') != ''){?><?php echo set_value('cp_two_phone_no'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_two_phone_no']?><?php } ?>" placeholder="Phone No" maxlength="10" onpaste="return false">
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Age <font color="red">*</font></label>
                        <div class="col-sm-6">
                           <input type="text" class="form-control" placeholder="Age of Male" name="cp_two_age" id="cp_two_age" placeholder="Age" autocomplete="off" value="<?php if(set_value('cp_two_age') != ''){?><?php echo set_value('cp_two_age'); ?><?php }else{?><?php echo $incident_edit_details[0]['cp_two_age']?><?php } ?>" readonly style="cursor: not-allowed;">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           ...
                           <label class="radio-inline"><input type="radio" name="cp_two_dob_document_available" class="dob_document_cp_two" value="2" <?php echo set_radio('cp_two_dob_document_available', '2'); ?><?php echo ($incident_edit_details[0]['cp_two_dob_document_available']== '2') ?  "checked" : "" ;  ?>>&nbsp;No</label>&nbsp;&nbsp;
                  ...
                  <div class="card-body" id="dob_document_available_cp_two" <?php if($incident_edit_details[0]['cp_two_dob_document_available'] == 1){?>style="display: block;"<?php }else{ ?>style="display: none;"<?php } ?>>
                     <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Document ID</label>
                        <div class="col-sm-6">
                           <input type="text" class="form-control" placeholder="Document ID" name="cp_two_dob_document_id" id="cp_two_dob_document_id" autocomplete="off" maxlength="12" value="<?php echo set_value('cp_two_dob_document_id'); ?> <?php echo $incident_edit_details[0]['cp_two_dob_document_id']; ?>">
