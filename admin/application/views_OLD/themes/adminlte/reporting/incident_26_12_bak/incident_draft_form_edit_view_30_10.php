               ...
               <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                     <?php 
                        if($incident_edit_details['incident_date']!='')
                        {
                           $incident_date = $incident_edit_details['incident_date'];
                        }
                        else
                        {
                     ...
                     ?>
                      <input type="text" class="form-control datepicker" data-date-end-date="0d" id="incident_date" placeholder="Incident Date" readonly autocomplete="off" name="incident_date" value="<?=($incident_edit_details)?date('d/m/Y',strtotime($incident_date)):set_value('incident_date'); ?>" style="background-color: white;" tabindex="7">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" placeholder="Street / Landmark" class="form-control" id="street_landmark" autocomplete="off" name="street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['street_landmark']:set_value('street_landmark'); ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                     <input type="text" name="pin_code" id="pin_code" class="form-control pin_code_validate" value="<?=($incident_edit_details)?$incident_edit_details['pin_code']:set_value('pin_code'); ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" placeholder="Police Station" name="police_station" id="police_station" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['police_station']:set_value('police_station'); ?>">
            ...
            <div id="submenu1" class="tab-pane fade">
               ...
               <div class="card-body" id="Anonymous_1">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="If identity known Name" name="identity_known_name" id="identity_known_name" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['identity_known_name']:set_value('identity_known_name'); ?>" onkeypress="return Identity_Known_Name_Validate(event);">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Street / Landmark</label>
                    <div class="col-sm-9">
                      <input type="text" placeholder="Street / Landmark" class="form-control" id="identity_street_landmark" autocomplete="off" name="identity_street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['identity_street_landmark']:set_value('identity_street_landmark'); ?>">
               ...
               <div class="card-body" id="Anonymous_2">
                  <div class="left-form">
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-sm-5"> 
                           <input type="text" id="identity_pin_code" name="identity_pin_code" class="form-control identity_pin_code_validate" value="<?=($incident_edit_details)?$incident_edit_details['identity_pin_code']:set_value('identity_pin_code'); ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
                     ...
                     <div class="form-group row">
                       <label class="col-sm-3 col-form-label">Police Station <font color="red">*</font></label>
                       <div class="col-sm-5">
                         <input type="text" class="form-control" placeholder="Police Station" name="identity_police_station" id="identity_police_station" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['identity_police_station']:set_value('identity_police_station'); ?>">
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-sm-5">
                           <input type="text" name="identity_phone_no" id="identity_phone_no" class="form-control identity_phone_no_validate" value="<?=($incident_edit_details)?$incident_edit_details['identity_phone_no']:set_value('identity_phone_no'); ?>" placeholder="Phone No" maxlength="10" onpaste="return false">
            ...
            <div id="menu1" class="tab-pane fade">
               ...
               <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Name <font color="red">*</font></label>
                     <div class="col-sm-3">
                        <input type="text" class="form-control" placeholder="First Name" name="cp_one_f_name" id="cp_one_f_name" autocomplete="off" value="<?=($cp_one_f_name)?$cp_one_f_name:set_value('cp_one_f_name'); ?>" onkeypress="return CP_One_First_Name_Validate(event);"> 
                        <span id="cp_one_first_name_lbl_error" style="color: red"></span> 
                        <?php echo form_error('cp_one_f_name');?>
                     </div>
                     <div class="col-sm-3">
                        <input type="text" class="form-control" placeholder="Middle Name" name="cp_one_m_name" id="cp_one_m_name" autocomplete="off" value="<?=($cp_one_m_name)?$cp_one_m_name:set_value('cp_one_m_name'); ?>" onkeypress="return CP_One_Middle_Name_Validate(event);"> 
                        <span id="cp_one_middle_name_lbl_error" style="color: red"></span>
                     </div>
                     <div class="col-sm-3">
                        <input type="text" class="form-control" placeholder="Last Name" name="cp_one_l_name" id="cp_one_l_name" autocomplete="off" value="<?=($cp_one_l_name)?$cp_one_l_name:set_value('cp_one_l_name'); ?>" onkeypress="return CP_One_Last_Name_Validate(event);"> 
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Street / Landmark</label>
                    <div class="col-sm-9">
                      <input type="text" placeholder="Street / Landmark" class="form-control" id="cp_one_street_landmark" autocomplete="off" name="cp_one_street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_street_landmark']:set_value('cp_one_street_landmark'); ?>">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Pin Code <font color="red">*</font></label>
                    <div class="col-sm-6">
                        <input type="text" name="cp_one_pin_code" id="cp_one_pin_code" class="form-control cp_one_pin_code_validate" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_pin_code']:set_value('cp_one_pin_code'); ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Police Station <font color="red">*</font></label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" placeholder="Police Station" name="cp_one_police_station" id="cp_one_police_station" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_police_station']:set_value('cp_one_police_station'); ?>">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Phone No <font color="red">*</font></label>
                    <div class="col-sm-6">
                        <input type="text" name="cp_one_phone_no" id="cp_one_phone_no" class="form-control cp_one_phone_no_validate" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_phone_no']:set_value('cp_one_phone_no'); ?>" placeholder="Phone No" maxlength="10" onpaste="return false">
               ...
               <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control datepicker" data-date-end-date="0d" id="cp_one_dob" placeholder="Date of Birth" autocomplete="off" name="cp_one_dob" value="<?=($incident_edit_details)?date('d/m/Y',strtotime($incident_edit_details['cp_1_dob'])):set_value('cp_one_dob'); ?>" style="background-color: white;" readonly tabindex="7">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control js-input-mobile" name="cp_one_age" id="cp_one_age" autocomplete="off" placeholder="Age" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_age']:set_value('cp_one_age'); ?>" maxlength="2" readonly style="cursor: not-allowed;">
               ...
               <div class="card-body" id="dob_document_available_cp_one">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" placeholder="Document ID" name="cp_one_dob_document_id" id="cp_one_dob_document_id" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_dob_document_id']:set_value('cp_one_dob_document_id'); ?>">
               ...
               <div class="card-body" id="identity_document_available_cp_one">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Document ID</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" placeholder="Document ID" name="cp_one_identity_document_id" id="cp_one_identity_document_id" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_identity_document_id']:set_value('cp_one_identity_document_id'); ?>">
                        ...
                        <div class="col-sm-12">
                           <table class="table table-bordered" id="documents_collected_table_field">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" class="form-control" id="cp_one_father_name" name="cp_one_father_name" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_father_name']:set_value('cp_one_father_name'); ?>" onkeypress="return CP_One_Father_Name_Validate(event);">
                                    <span id="cp_one_father_name_lbl_error" style="color: red;float: left;"></span>
                                    <?php echo form_error('cp_one_father_name');?> 
                                 </td>
                                 <td>
                                    <input type="text" class="form-control js-input-alphanumeric" id="cp_one_mother_name" name="cp_one_mother_name" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_mother_name']:set_value('cp_one_mother_name'); ?>" onkeypress="return CP_One_Mother_Name_Validate(event);">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_father_mobile_no" id="cp_one_father_mobile_no" onkeyup="cp_one_father_mobile_number_validation()" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_father_mobile_no']:set_value('cp_one_father_mobile_no'); ?>" onpaste="return false">
                                    <span id="cp_one_father_mobile_lbl_error" style="color: red;float: left;"></span> 
                                    <?php echo form_error('cp_one_father_mobile_no');?> 
                                 </td>
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_mother_mobile_no" id="cp_one_mother_mobile_no" onkeyup="cp_one_mother_mobile_number_validation()" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_mother_mobile_no']:set_value('cp_one_mother_mobile_no'); ?>" onpaste="return false">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_father_id" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_father_id']:set_value('cp_one_father_id'); ?>">
                                    <?php echo form_error('cp_one_father_id');?>
                                 </td>
                                 <td>
                                    <input type="text" class="form-control" name="cp_one_mother_id" value="<?=($incident_edit_details)?$incident_edit_details['cp_1_mother_id']:set_value('cp_one_mother_id'); ?>">
                ...
                <div id="cp_two_hide_show_div">
                    <div class="card-body">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Name <font color="red">*</font></label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" placeholder="First Name" id="cp_two_f_name" name="cp_two_f_name" autocomplete="off" value="<?=($cp_two_l_name)?$cp_two_l_name:set_value('cp_two_f_name'); ?>" onkeypress="return CP_Two_First_Name_Validate(event);"> 
                            <span id="cp_two_first_name_lbl_error" style="color: red"></span>
                            <?php echo form_error('cp_two_f_name');?>  
                         </div>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" placeholder="Middle Name" id="cp_two_m_name" name="cp_two_m_name" autocomplete="off" value="<?=($cp_two_m_name)?$cp_two_m_name:set_value('cp_two_m_name'); ?>" onkeypress="return CP_Two_Middle_Name_Validate(event);">  
                            <span id="cp_two_middle_name_lbl_error" style="color: red"></span>
                         </div>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" placeholder="Last Name" id="cp_two_l_name" name="cp_two_l_name" autocomplete="off" value="<?=($cp_two_l_name)?$cp_two_l_name:set_value('cp_two_l_name'); ?>" onkeypress="return CP_Two_Last_Name_Validate(event);"> 
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Street / Landmark</label>
                        <div class="col-sm-9">
                          <input type="text" placeholder="Street / Landmark" class="form-control" id="cp_two_street_landmark" autocomplete="off" name="cp_two_street_landmark" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_street_landmark']:set_value('cp_two_street_landmark'); ?>">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Pin Code <font color="red">*</font></label>
                        <div class="col-sm-6">
                            <input type="text" name="cp_two_pin_code" id="cp_two_pin_code" class="form-control cp_two_pin_code_vaidate" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_pin_code']:set_value('cp_two_pin_code'); ?>" placeholder="Pin Code" maxlength="6" onpaste="return false">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Police Station <font color="red">*</font></label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" placeholder="Police Station" name="cp_two_police_station" id="cp_two_police_station" autocomplete="off" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_police_station']:set_value('cp_two_police_station'); ?>">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Phone No <font color="red">*</font></label>
                        <div class="col-sm-6">
                            <input type="text" name="cp_two_phone_no" id="cp_two_phone_no" class="form-control cp_two_phone_no_vaidate" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_phone_no']:set_value('cp_two_phone_no'); ?>" placeholder="Phone No" maxlength="10" onpaste="return false">
                   ...
                   <div class="card-body">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Date of Birth (dd/mm/yyyy) <font color="red">*</font></label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control datepicker" data-date-end-date="0d" id="cp_two_dob" placeholder="Date of Birth" autocomplete="off" name="cp_two_dob" value="<?=($incident_edit_details)?date('d/m/Y',strtotime($incident_edit_details['cp_2_dob'])):set_value('cp_two_dob'); ?>" style="background-color: white;" readonly tabindex="7">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Age <font color="red">*</font></label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control js-input-mobile" name="cp_two_age" id="cp_two_age" autocomplete="off" placeholder="Age" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_age']:set_value('cp_two_age'); ?>" maxlength="2" readonly style="cursor: not-allowed;">
                   ...
                   <div class="card-body" id="dob_document_available_cp_two">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Document ID</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" placeholder="Document ID" name="cp_two_dob_document_id" id="cp_two_dob_document_id" autocomplete="off" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_dob_document_id']:set_value('cp_two_dob_document_id'); ?>">
                   ...
                   <div class="card-body" id="identity_document_available_cp_two"> 
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Document ID</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" placeholder="Document ID" name="cp_two_identity_document_id" id="cp_two_identity_document_id" autocomplete="off" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_identity_document_id']:set_value('cp_two_identity_document_id'); ?>">
                            ...
                            <div class="col-sm-12">
                               <table class="table table-bordered" id="documents_collected_table_field">
                                  ...
                                  <tr>
                                     <td style="text-align: left; font-weight: bold;">Name</td>
                                     <td>
                                        <input type="text" class="form-control" id="cp_two_father_name" name="cp_two_father_name" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_father_name']:set_value('cp_two_father_name'); ?>" onkeypress="return CP_Two_Father_Name_Validate(event);">
                                        <span id="cp_two_father_name_lbl_error" style="color: red;float: left;"></span>
                                        <?php echo form_error('cp_two_father_name');?>   
                                     </td>
                                     <td>
                                        <input type="text" class="form-control" id="cp_two_mother_name" name="cp_two_mother_name" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_mother_name']:set_value('cp_two_mother_name'); ?>" onkeypress="return CP_Two_Mother_Name_Validate(event);">
                                  ...
                                  <tr>
                                     <td style="text-align: left; font-weight: bold;">Phone No</td>
                                     <td>
                                        <input type="text" class="form-control" name="cp_two_father_mobile_no" id="cp_two_father_mobile_no" onkeyup="cp_two_father_mobile_number_validation()" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_father_mobile_no']:set_value('cp_two_father_mobile_no'); ?>" onpaste="return false">
                                        <span id="cp_two_father_mobile_lbl_error" style="color: red;float: left;"></span>
                                        <?php echo form_error('cp_two_father_mobile_no');?>
                                     </td>
                                     <td>
                                        <input type="text" class="form-control" name="cp_two_mother_mobile_no" id="cp_two_mother_mobile_no" onkeyup="cp_two_mother_mobile_number_validation()" maxlength="10" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_mother_mobile_no']:set_value('cp_two_mother_mobile_no'); ?>" onpaste="return false">
                                  ...
                                  <tr>
                                     <td style="text-align: left; font-weight: bold;">ID</td>
                                     <td>
                                        <input type="text" class="form-control" name="cp_two_father_id" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_father_id']:set_value('cp_two_father_id'); ?>">
                                        <?php echo form_error('cp_two_father_id');?>
                                     </td>
                                     <td>
                                        <input type="text" class="form-control" name="cp_two_mother_id" value="<?=($incident_edit_details)?$incident_edit_details['cp_2_mother_id']:set_value('cp_two_mother_id'); ?>">
