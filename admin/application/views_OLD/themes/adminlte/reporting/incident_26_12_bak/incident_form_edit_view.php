               ...
               `  
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="marriage_date" readonly autocomplete="off" name="marriage_date" value="<?=$marriage_date; ?>" style="background-color: white;" tabindex="7"onClick="hide_trash_button()">
