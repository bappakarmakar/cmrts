               ...
               <div class="form-group row">
                ...
                <div class="row">
                  ...
                  <label class="col-sm-3 col-form-label">Date of marriage&nbsp;(dd/mm/yyyy)</label>
                    <div class="col-sm-3">
                      <div class="d-flex">
                      <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="Marriage Date" readonly autocomplete="off" name="marriage_date" value="<?php echo set_value('marriage_date'); ?>" style="background-color: white;" tabindex="7" onClick="hide_trash_button()">
                    ...
                    <div class="col-sm-6">
                     ...
                     <?php foreach($marriage_details as $key => $value){
                        if($key == 0){
                           $marriage_details_css = 'margin-left: 357px';
                        }elseif($key == 1){
                           $marriage_details_css = 'margin-left: 339px';
                        }else{
                           $marriage_details_css = 'margin-left: 370px';
                        }
                     ?>
...
<script type="text/javascript">
  swal({
    title: "The Intervention Report has been saved in the Register1111111",
    type: "warning",
    confirmButtonClass: "btn-success",
