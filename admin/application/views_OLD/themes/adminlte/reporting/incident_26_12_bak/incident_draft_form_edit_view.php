...
?>
   <section class="content-header">
      ...
      <?php echo "<p>".$validation_error_count."</p>"; ?>
      <ol class="breadcrumb">
            ...
            <div id="home" class="tab-pane fade in active">
              ...
              <div class="card-body">
               <div class="form-group row">
                ...
                <div class="row">
                  <!-- <label class="col-sm-3 col-form-label">Date of marraiage available?&nbsp;</label> -->
                  ...
                  <label class="col-sm-3 col-form-label">Date of marriage&nbsp;(dd/mm/yyyy)</label>
                    <div class="col-sm-3">
                     <div class="d-flex">
                      <input type="text" class="form-control datepicker" data-date-end-date="0d" id="marriage_date" placeholder="Marriage Date" readonly autocomplete="off" name="marriage_date" value="<?=$marriage_date; ?>" style="background-color: white;" tabindex="7" onClick="hide_trash_button()">
