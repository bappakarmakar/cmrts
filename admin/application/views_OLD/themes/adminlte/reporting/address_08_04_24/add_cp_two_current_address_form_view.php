...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <div class="box bottom-box">
         <?php echo form_open('admin/reporting/address/address_list/add_cp_two_current_address/'.$record_num, array('class' => 'AddressChangeForm','name' => 'AddressChangeForm', 'id' => 'AddressChangeForm')) ?>
        ...
        if(fetch_entered_address == undefined){
            ...
            $.ajax({
              ...
              success: function(response)
              {
                ...
                var street_landmark = response.cp_two_street_landmark;
                var cp_two_police_station = response.cp_two_police_station;
                var cp_two_pin_code = response.cp_two_pin_code;
                var cp_two_ward_gp = response.cp_two_ward_gp;
