         ...
         <div class="box-body">
            <div class="card-body">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                    <select class="form-control" name="block">
                       ...
                       <option value="<?php echo $value['block_id_pk']; ?>" <?php echo set_select('block', $value['block_id_pk']); ?>><?php echo $value['block_name']; ?></option> 
                       <?php } ?>
                    </select>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                   <input type="text" class="form-control" placeholder="Username" autocomplete="off" name="username" value="<?php echo $login_id; ?>" readonly style="cursor: not-allowed">
