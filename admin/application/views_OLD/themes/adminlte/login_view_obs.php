      ...
      <!-- <div class="row">
       ...
       <div class="row">
         <div class="col-sm-12">
            <div class="form-group">
               <div class="userid_box">
                  <input type="text" name="login_id" id="login_id" class="custom_login_box" placeholder="Username" value="DEO.Falakata.Alipurduar">
                  <?php echo form_error('login_id'); ?>
                  <?php echo (isset($user_error_message)) ? $user_error_message : "";?>
               </div>
            </div>
         ...
         <div class="col-sm-12">
            <div class="form-group">
               <div class="password_box">
                  <input type="password" class="custom_login_box" name="password" id="password" placeholder="Password" value="Admin123#">
                  <?php echo form_error('password'); ?>
                  <?php echo (isset($password_error_message)) ? $password_error_message : "";?>
               </div>
            </div>
         ...
         <div class="col-sm-8">
            <div class="form-group">
               <div class="login_captcha">
                   <input type="text" class="custom_login_box" name="captcha" id="captcha" placeholder="Captcha" value="<?= $cap['word'];?>">
                   <?php echo form_error('captcha'); ?>
               </div>
            </div>
         </div>
