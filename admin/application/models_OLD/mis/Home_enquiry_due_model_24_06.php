...
class Home_enquiry_due_model extends CI_Model
{
    ...
    public function get_home_enquiry_due_dtls($data=array())
    {
        ...
        $this->db->join('rp_location_master_district as district_master', 'cmir.district = district_master.district_id_pk','left');
        $this->db->join('rp_location_master_block as block_master', 'cmir.block = block_master.block_id_pk','left');
