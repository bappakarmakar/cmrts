...
class Religion_wise_report_model extends CI_Model
{

    private $selection = "
      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion=1 THEN 1 ELSE 0 END) AS male_count_hindu, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion=1 THEN 1 ELSE 0 END) AS female_count_hindu, 

      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion=2 THEN 1 ELSE 0 END) AS male_count_muslim, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion=2 THEN 1 ELSE 0 END) AS female_count_muslim, 

      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion=3 THEN 1 ELSE 0 END) AS male_count_sikh, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion=3 THEN 1 ELSE 0 END) AS female_count_sikh, 

      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion=4 THEN 1 ELSE 0 END) AS male_count_buddhist, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion=4 THEN 1 ELSE 0 END) AS female_count_buddhist, 

      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion=5 THEN 1 ELSE 0 END) AS male_count_christian, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion=5 THEN 1 ELSE 0 END) AS female_count_christian, 

      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion=6 THEN 1 ELSE 0 END) AS male_count_other, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion=6 THEN 1 ELSE 0 END) AS female_count_other, 
      
      SUM(CASE WHEN ircpt.cp_gender = 1 AND ircpt.cp_religion is NULL THEN 1 ELSE 0 END) AS male_count_not_report, 
      SUM(CASE WHEN ircpt.cp_gender = 2 AND ircpt.cp_religion is NULL THEN 1 ELSE 0 END) AS female_count_not_report, 
    ...
    public function get_religion_wise_child_dtls($data=array())
    {
